...
assert(salesJs.includes('Active GLS cases') && salesJs.includes('Needs owner') && salesJs.includes('Assigned'), 'GLS dashboard must expose active case, needs-owner, and assigned counts in one top scoreboard.')
...
assert(salesJs.includes('Adjusted / implemented') && salesJs.includes('Sold') && salesJs.includes('Failed'), 'GLS top scoreboard must expose adjusted/implemented, sold, and failed counts.')
