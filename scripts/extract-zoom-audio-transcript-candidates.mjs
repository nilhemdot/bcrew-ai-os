  ...
  for (const artifact of artifacts) {
    ...
    try {
      ...
      const rejected = await rejectSharedCommunicationCandidatesForArtifacts({
        ...
        actor: 'system',
        reason: 'Historical Zoom audio transcript extraction rerun superseded stale pending candidates after successful replacement extraction.',
      });
      ...
      await recordSharedCommunicationArtifactProcessingRun(
        {
          ...
          metadata: {
            script: 'extract-zoom-audio-transcript-candidates',
