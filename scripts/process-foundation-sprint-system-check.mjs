  ...
  try {
    ...
    const [
      ...
      Promise.all([
        ...
        readText('public/foundation-source-registry-renderers.js').catch(error => {
          if (error && error.code === 'ENOENT') return ''
          throw error
        }),
        readText('public/foundation-fub-lead-source-renderers.js').catch(error => {
          if (error && error.code === 'ENOENT') return ''
          throw error
        }),
        readText('public/foundation-system-inventory-renderers.js').catch(error => {
