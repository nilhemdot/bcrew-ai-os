...
async function main() {
  ...
  addCheck(checks, jsSource.includes('YouTube Creators') && jsSource.includes('Creator Source Stack') && jsSource.includes('Creator Newsletters') && jsSource.includes('Skool / Free Communities') && jsSource.includes('Skool / Paid Courses') && jsSource.includes('GitHub / Repos') && jsSource.includes('Gmail / Missive / Slack') && jsSource.includes('Meetings / Transcripts') && jsSource.includes("label: 'Visual evidence'") && jsSource.includes("label: 'Links to review'") && !jsSource.includes("name: 'Video Artifacts'") && !jsSource.includes("name: 'Dev Director'") && !jsSource.includes("name: 'God Mode Eyes'"), 'source cards are actual source inputs and evidence is separate output', 'sources: YouTube/source-stack/newsletters/free Skool/paid Skool/GitHub/internal/meetings; evidence cards carry output counts')
