...
const extractionTargets = [
  ...
  },
  {
    ...
    notes: 'Finds Loom, Drive, YouTube, Vimeo, Wistia, Zoom, and Skool media links from existing archives and Drive inventory before any platform-specific extractor runs.',
  },
  {
