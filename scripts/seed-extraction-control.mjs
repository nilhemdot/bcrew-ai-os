...
const extractionTargets = [
  {
    ...
    metadata: { foundationJobKey: 'gmail-sync-current', promotionGate: 'manual runner stable plus cursor semantics' },
    notes: 'Current-day lane comes before historical Gmail backfill. Keep this fresh without waiting for 180-day depth.',
  },
  {
    ...
    metadata: { foundationJobKey: 'missive-sync-current', promotionGate: 'rate-limit and cursor behavior clean' },
    notes: 'Priority email lane because Missive carries internal comments/chats inside threads.',
  },
  {
