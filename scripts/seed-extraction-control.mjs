...
const extractionTargets = [
  ...
  },
  {
    ...
    metadata: { foundationJobKey: 'slack-sync-current', sourceScript: 'slack:sync-archive' },
  ...
  },
  {
    ...
    metadata: { backlogIds: ['DRIVE-CORPUS-001', 'EXTRACTION-TEAM-001'], sourceNote: 'docs/source-notes/google-drive-corpus.md', promotionGate: 'read-only direct-child inventory proof before export/copy/extract', futureExtractionMission: { unit: 'file_outputs', maxPerDay: 5, requiresFiledOutput: true } },
    notes: 'Daily mission lane, not a timer: inventory one bounded Drive bite, then later promote to about five filed Drive extractions per day.',
  },
  {
