...
const extractionTargets = [
  ...
  },
  {
    ...
    metadata: {
      ...
      officialApiBasis: ['Drive files.export for Google Docs', 'Sheets API spreadsheets.values.get for Google Sheets', 'Drive files.get alt=media for PDFs/text blobs'],
    },
