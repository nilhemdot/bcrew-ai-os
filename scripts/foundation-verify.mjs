...
async function main() {
  ...
  const knownLaterFoundationProgressionBlockers = [
    ...
    'SCHEDULED-JOB-STALENESS-DASHBOARD-001', 'SYSTEM-HEALTH-RED-ROW-REPAIR-001', 'VERIFICATION-RUNS-READONLY-SPLIT-001', 'CONNECTOR-BLOCKED-ROW-DIAGNOSIS-001', 'CONNECTOR-COMPLETION-SPRINT',
  ]
