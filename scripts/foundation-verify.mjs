...
import {
  ...
  FOUNDATION_MAIN_INTEGRATION_LOCK_DONE_CARD_IDS_FOR_VERIFIER_COVERAGE,
  ...
  BRAIN_FLEET_FOUNDATION_DONE_CARD_IDS_FOR_VERIFIER_COVERAGE,
  BRAIN_FLEET_QUOTA_LEDGER_DONE_CARD_IDS_FOR_VERIFIER_COVERAGE,
  BRAIN_FLEET_MODEL_CAPABILITY_REGISTRY_DONE_CARD_IDS_FOR_VERIFIER_COVERAGE,
  CODEX_DIRECT_SUBSCRIPTION_ROUTE_DONE_CARD_IDS_FOR_VERIFIER_COVERAGE,
  GEMINI_VIDEO_BRAIN_ROUTE_DONE_CARD_IDS_FOR_VERIFIER_COVERAGE,
  CLAUDE_CODE_REVIEW_BRAIN_ROUTE_DONE_CARD_IDS_FOR_VERIFIER_COVERAGE,
  OPENCLAW_ADAPTER_BOUNDARY_DONE_CARD_IDS_FOR_VERIFIER_COVERAGE,
  EXTRACTOR_BRAIN_FLEET_PROOF_DONE_CARD_IDS_FOR_VERIFIER_COVERAGE,
...
async function main() {
  ...
  const extractionLaneItemShapeAudit = await readRepoFile('docs/_archive/audits/2026-04-28-extraction-lane-item-shape.md')
  const devProcessAuditSource = await readRepoFile('docs/_archive/audits/2026-04-28-dev-process-audit.md')
  ...
  const fullSystemReAuditSource = await readRepoFile('docs/_archive/audits/2026-04-29-full-system-re-audit.md')
