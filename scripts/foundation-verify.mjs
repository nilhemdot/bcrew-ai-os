...
async function main() {
  ...
  const processControlGovernanceVerifier = await evaluateFoundationVerifierProcessControlGovernanceOrchestration({
    ...
    controlLoopBundle: { DRIVE_ACCESS_REQUEST_CARD_ID, EXTRACT_RUN_HARDENING_CARD_ID, FOUNDATION_DONE_TEST_CARD_ID, FOUNDATION_DONE_TEST_CLOSEOUT_KEY, FOUNDATION_DONE_TEST_PLAN_PATH, FOUNDATION_DONE_TEST_SUMMARY_MARKER, FOUNDATION_READINESS_GATE_CARD_IDS, FOUNDATION_READINESS_REQUIRED_LEG_KEYS, MEETING_VAULT_ACL_CARD_ID, SOURCE_LIFECYCLE_COMPLETION_CARD_ID, SYNTHESIS_VERIFY_CARD_ID, SYSTEM_010_CARD_ID, SYSTEM_010_CLOSEOUT_KEY, SYSTEM_010_PLAN_PATH, actionReviewApi, actionReviewApproval, actionRouterSnapshot, backlogHygieneApi, buildLogFoundationDoneTestBuild, buildLogSystem010GhostCloseoutBuild, currentPlan, currentState, foundationBuildCloseouts, foundationBuildIntelRoutesSource, foundationDbSource, foundationDoneTest, foundationDoneTestApproval, foundationDoneTestApprovalValidation, foundationDoneTestDocSource, foundationDoneTestPlanSource, foundationDoneTestReadinessStatus, foundationDoneTestRegistrySource, foundationDoneTestScriptSource, foundationFrontendSource, foundationHub, foundationJobsSource, foundationRuntimeReadRoutesSource, meetingVaultAutoEnforcementClosed, packageJson, serverRouteSource, sourceRegistry, strategySharedCommsRouteSource, system010Approval, system010ApprovalValidation, system010DocSource, system010GhostCloseout, system010PlanSource, system010ProcessScriptSource, system010RuntimeSource },
