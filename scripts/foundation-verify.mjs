...
async function main() {
  ...
  const knownLaterFoundationProgressionBlockers = [
    ...
    'AGENT-TEMPLATE-RUNTIME-CONTRACT-001', 'OLD-SYSTEM-AGENT-ONBOARDING-HARVEST-001', 'AGENT-010', 'ROLE-ASSISTANT-CONTRACTS-001', 'HARLAN-PROJECT-REGISTRY-001', 'HARLAN-OPERATOR-LOOP-V1-001',
