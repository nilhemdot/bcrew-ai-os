...
async function main() {
  ...
  console.log(`  Direct verifier deadlock diagnostic: ${proof.directVerifierDeadlockDiagnostic.transientClass || 'missing'} / ${proof.directVerifierDeadlockDiagnostic.subsystem || 'missing'} / ${proof.directVerifierDeadlockDiagnostic.postgresCode || 'missing'} (${proof.directVerifierDeadlockDiagnostic.attempts} attempts)`)
