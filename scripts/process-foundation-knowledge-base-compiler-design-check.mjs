...
async function main() {
  ...
  addCheck(checks, qualityCard && ['research', 'scoped'].includes(qualityCard.lane), 'quality gate follow-up exists but is not built by this card', qualityCard ? `${qualityCard.id}:${qualityCard.lane}` : 'missing')
