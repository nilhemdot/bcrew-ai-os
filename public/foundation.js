...
var sectionParents = {
  ...
  'user-steve': { label: 'People / Agents', href: '/foundation#users' },
  'agent-harlan': { label: 'People / Agents', href: '/foundation#agents' },
  'agent-crewbert': { label: 'People / Agents', href: '/foundation#agents' },
