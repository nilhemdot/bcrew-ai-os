...
Do **not** use this folder for local-only runtime state like `USER.md`.

## Rules

- `USER.md` stays local-only
- tracked user docs live here
- each real user gets one file
- keep these files operational, not personal
