...
| Shared communications intelligence | Open now | Gmail, Calendar, Missive, Slack, meetings, recovered Zoom chats/audio, archive, extraction, and persisted synthesis are live enough for proof. Exact archive counts belong to coverage job/dashboard, not this static file. Extraction doctrine now requires useful material to route to strategy, ops, sales, marketing, recruiting, agent coaching, and Steve-owned content/course lanes instead of only becoming raw archive. System Health now has an Intelligence Pipeline panel that shows archived artifacts, artifacts with active candidates, unmined backlog, extraction coverage percent, and latest synthesis so runtime progress is visible. `shared-comms-intelligence-bite` is a manual composite job that runs one bounded Gmail, Missive, meeting-transcript, and synthesis pass when Steve needs freshness without broad LLM scheduling. Latest synthesis proof after email/transcript extraction recorded `synth-20260424T194613Z-530692804e` with `11` ranked items, led by June cash shortfall, KPI dashboard/source-trust incident, SocialPilot instability, old automations still firing, automation failure pattern, lead-source hygiene, finance reconciliation, FUB/Owners identity mismatch, and Google Ads routing risk. | Close `SOURCE-019`, `SOURCE-020`, `COMMS-BACKFILL-001`, `EXTRACTION-TEAM-001`, `HUB-INTEL-001`, `SYNTHESIS-FACTS-001`, and `SYNTHESIS-ENGINE-001` through runtime/extraction/synthesis hardening. | Broader apply flows, subject-person privacy/query layer, and leadership packets. |
