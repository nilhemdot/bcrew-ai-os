...
- Scheduled daily history/extraction missions: Gmail candidate extraction, Missive candidate extraction, meeting transcript extraction, Slack candidate extraction, and Drive corpus inventory.
- Built but not yet content-extracting: Drive file-content extraction, Gmail/Missive attachment extraction, and meeting-linked video/recording review. The daily Drive lane inventories/maps folders and files first; the separate filed-output extractor is still backlog work.
