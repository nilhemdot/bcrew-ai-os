...
- Built for first text slice: Drive Google Docs, PDFs, and plain-text files can now be extracted from inventory into source-backed artifacts. Still not built: Gmail/Missive attachment extraction, meeting-linked video/recording review, Drive Sheets/Slides/Office conversion, shortcuts, OCR, and rich video/audio extraction.
