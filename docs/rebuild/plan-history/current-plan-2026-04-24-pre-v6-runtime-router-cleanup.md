...
Use [Doc Cleanup And Consolidation Plan](doc-cleanup-plan.md) for the cleanup path that keeps historical handoffs/audits as indexed evidence instead of active doctrine.
...
- [Doc Cleanup And Consolidation Plan](doc-cleanup-plan.md)
