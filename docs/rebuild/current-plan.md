...
1. `AGENT-FEEDBACK-PRODUCTION-AUTOSEND-ENABLE-001`: only with separate production approval, dry-run production report first, then production-all only after explicit approval.
