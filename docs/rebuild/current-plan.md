...
18. `SOURCE-PACKET-WORKER-RUNNER-001` - P0. V1 synthetic proof exists for approved source-packet decision -> exact public-page worker -> artifact -> freshness/status. Next is live DB/artifact persistence and UI status wiring; keep broad crawling blocked.
