...
12. `BUILD-OPPORTUNITY-PROMOTION-GATE-001` - after Scoper produces enough implementation detail, approve source-backed build opportunities into backlog cards or existing-card attachments.
