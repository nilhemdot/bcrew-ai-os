...
22. `SYNTHESIS-ROUTER-FRESHNESS-TRIGGER-001` - P0. Trigger or flag synthesis after extractor/source runs so stale brain-layer output cannot look current.
