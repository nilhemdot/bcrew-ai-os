...
- Raw risk/watch before classification: 4/4
...
| red | Verification Runs | none | no | Verification Runs latest run is failed. |
...
- P1 Verification Runs is risk: Verification Runs latest run is failed. Next: Exited with code 1
