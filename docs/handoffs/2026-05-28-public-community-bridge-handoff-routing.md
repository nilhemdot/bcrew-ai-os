...
- browser challenges and interstitial wrapper pages fail closed instead of becoming empty successful source evidence
...
- 460 parked rows
- 699 already persisted rows
- 3 free-community bridge rows read
