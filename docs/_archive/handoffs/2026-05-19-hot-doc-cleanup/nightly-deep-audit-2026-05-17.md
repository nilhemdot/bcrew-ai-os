# Nightly Deep Audit Report - 2026-05-17
...
- Deterministic findings: 56 total (42 P0, 7 P1, 7 P2, 0 P3)
...
- /api/foundation-hub: 84ms, 587916B, risk=healthy (Within V1 audit budget.)
- /api/source-of-truth: 23ms, 138932B, risk=healthy (Within V1 audit budget.)
- /api/foundation/source-lifecycle: 382ms, 624834B, risk=healthy (Within V1 audit budget.)
- /api/foundation/build-log: 77ms, 322537B, risk=healthy (Within V1 audit budget.)
- /api/foundation/gstack-build-intel: 76ms, 33955B, risk=healthy (Within V1 audit budget.)

## Largest Files

- scripts/foundation-verify.mjs: 8728 LOC, 476274B
...
- Lines: 8728
- Bytes: 476274
- Reasons: changed_since_baseline, over_5k_refactor_required, verifier_trust_surface
...
### P1 scripts/process-synthesis-verify-check.mjs
...
- Status: `watch`
- Handoff files: 190
- Handoff hot lines: 23003
- Nightly artifacts: 6
- Red/yellow findings: 0/1

- P1 docs/handoffs is growing past the hot-doc budget: docs/handoffs contains 23003 line(s); budget is 20000/35000 warn/risk.
...
Generated at: `2026-05-17T07:00:14.750Z`

## Morning Read

- Status: `report_ready`
- Findings: 56 total (42 P0, 7 P1, 7 P2, 0 P3)
...
- /api/foundation-hub: status=200 latency=84ms payload=587916B risk=healthy (Within V1 audit budget.)
- /api/source-of-truth: status=200 latency=23ms payload=138932B risk=healthy (Within V1 audit budget.)
- /api/foundation/source-lifecycle: status=200 latency=382ms payload=624834B risk=healthy (Within V1 audit budget.)
- /api/foundation/build-log: status=200 latency=77ms payload=322537B risk=healthy (Within V1 audit budget.)
- /api/foundation/gstack-build-intel: status=200 latency=76ms payload=33955B risk=healthy (Within V1 audit budget.)
...
- public/foundation-runtime-renderers.js: 79399B raw, 17197B gzip, 1894 lines
...
- Card lane: `FOUNDATION-MONOLITH-RISK-AUDIT-001`
- Type: `refactor_candidate`
- Evidence: `scripts/foundation-verify.mjs:2252`
- Why it matters: Large mixed-responsibility surfaces slow audits, increase merge risk, and make future proof harder to isolate.
