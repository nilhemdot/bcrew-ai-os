...
| Strategy Corpus / Shared Intelligence System | `SRC-GMAIL-001`, `SRC-MISSIVE-001`, `SRC-MEETINGS-001`, `SRC-SLACK-001`, `SRC-GDRIVE-001`, `SRC-VIDEO-001`, `SRC-LOOM-001`, `SRC-SKOOL-001`, `SRC-YOUTUBE-INTEL-001` | Meetings, email, Slack, Drive, and media into decisions, contradictions, tasks, atoms, and strategy evidence. Drive Docs/PDF/text v1 is live; attachments, video, Sheets, Slides, OCR, and shortcut resolution are still separate lanes. | [Google Drive corpus](source-notes/google-drive-corpus.md), [Video link inventory](source-notes/video-link-inventory.md) |
