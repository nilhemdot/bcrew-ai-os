...
export const VERIFIER_MODULE_ASSURANCE_SPLIT_HANDOFF_PATH = 'docs/handoffs/2026-05-17-verifier-module-assurance-split-closeout.md'
  ...
  const dbSchemaSeedSplitCloseout = foundationBuildCloseouts.find(closeout => closeout.key === FOUNDATION_DB_SCHEMA_SEED_SPLIT_CLOSEOUT_KEY) || null
    ...
    checks,
      ...
      (!dbSchemaSeedSplitClosed || (
        ...
        await repoFileExists('docs/handoffs/2026-05-18-foundation-db-schema-seed-split-closeout.md')
      )) &&
