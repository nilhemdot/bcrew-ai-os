...
export function buildBlockedSourceBrowserAgentExecution({
  ...
  const sourceSessionAuthResumePacket = plan.brokerDecision
    ? buildSourceSessionAuthResumePacket({ plan, now: capturedAt })
    : null
  ...
  const crawlItemWithResumePacket = sourceSessionAuthResumePacket
    ? {
        ...crawlItem,
        metadata: {
          ...(crawlItem.metadata || {}),
          sourceSessionAuthResumePacket,
        },
      }
    : crawlItem
  return {
    ...
    runnerReport: null,
    crawlItem: crawlItemWithResumePacket,
    sourceSessionAuthResumePacket,
    sideEffects: sideEffects(),
...
export function buildSourceBrowserAgentExecutionTargetInput({
  ...
  return {
    ...
    runtimeMode: 'manual',
    cursorState: {
      cursorType: 'exact_source_packet_recovery',
