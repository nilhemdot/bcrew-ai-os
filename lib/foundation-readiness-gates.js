...
export const FOUNDATION_READINESS_GATE_CARDS = [
  ...
  },
  {
    ...
    requiredForStrategy: true,
    closeoutKey: 'meeting-vault-acl-v1',
...
export function buildFoundationReadinessStatus({
  ...
  legs.push(meetingBlockers.length
    ? failedLeg(
      ...
      'Keep DRIVE-ACCESS-REQUEST-001 preflight closed, then close MEETING-VAULT-ACL-001 only when Phase A proves every file safe or separately approved Phase B repairs and rechecks the files.',
    )
