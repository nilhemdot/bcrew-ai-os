...
export async function buildRecentBuildsBillionDollarUiStatus({
  ...
  addFinding(findings, foundationJs.includes('renderBuildExecutiveSummary'), 'executive summary renderer exists', 'renderBuildExecutiveSummary')
  addFinding(findings, foundationJs.includes('renderBuildReviewQueue'), 'review-next queue renderer exists', 'renderBuildReviewQueue')
  addFinding(findings, foundationJs.includes('build-log-executive-summary'), 'executive summary class is rendered', 'build-log-executive-summary')
  addFinding(findings, foundationJs.includes('build-log-card-summary'), 'collapsed closeout summary is rendered', 'build-log-card-summary')
  addFinding(findings, foundationJs.includes('build-log-context-link'), 'context cards have separate UI treatment', 'build-log-context-link')
  addFinding(findings, foundationJs.includes('Grouped same-commit closeouts'), 'same-commit grouped closeouts remain visible', 'Grouped same-commit closeouts')
  addFinding(findings, foundationJs.includes('/api/foundation/build-log?limit=60'), 'UI reads live build-log API without a new endpoint', '/api/foundation/build-log?limit=60')
