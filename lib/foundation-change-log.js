...
export async function buildChangeLogComprehensiveStatus({
  ...
  addFinding(findings, serverSource.includes("app.get('/api/foundation/change-log'"), 'new change-log API route exists', '/api/foundation/change-log')
  addFinding(findings, serverSource.includes("app.get('/api/foundation/changes'"), 'old changes API route remains present', '/api/foundation/changes')
