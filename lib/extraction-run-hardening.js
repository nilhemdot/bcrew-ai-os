...
export const EXTRACTION_RETRY_FAILED_TARGETS = Object.freeze([
...
export function targetSupportsFailedItemRetry(targetKey) {
...
export function buildExtractionNextSafeCommand(target = {}, retrySummary = {}) {
  ...
  if (targetSupportsFailedItemRetry(targetKey)) {
    return `npm run extraction:retry-failed -- --target=${targetKey} --dryRun=true`
  }
