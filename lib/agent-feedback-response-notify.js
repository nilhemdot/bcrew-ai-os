...
export const AGENT_FEEDBACK_RESPONSE_NOTIFY_PROOF_PATH = 'docs/_archive/audits/2026-05-01-agent-feedback-response-notify-proof.md'
...
export async function buildAgentFeedbackResponseNotifyStatus({
  ...
  const dbSource = [
    ...
    await readOptionalText(repoRoot, 'lib/foundation-people-sales-db.js'),
    await readOptionalText(repoRoot, 'lib/foundation-agent-feedback-store.js'),
  ].join('\n')
