...
export const DEFAULT_LLM_ROUTES = [
  ...
  },
  {
    ...
    metadata: {
      ...
      intelligenceSpinePolicy: {
        ...
        requiredPosture: 'gpt-5.5_extra_high_fast',
        openClawPrimaryAllowed: false,
      },
    },
    notes: 'Primary official high-intelligence route for the core Intelligence Spine. Do not use OpenClaw 5.4/medium as the Director or synthesis brain.',
  },
  {
  ...
  },
  {
    ...
    notes: 'Official API route for bounded deep-audit senior review and core Intelligence Spine review. Direct Responses calls still require the spend-policy allow flag.',
  },
  {
