...
export const LLM_AUTH_AUDIT_REQUIRED_ROUTES = [
  ...
  { routeKey: 'foundation-extraction-openclaw-chatgpt', acceptedStatuses: ['available', 'probe_required', 'blocked'], policyClassification: ['allowed', 'experimental'] },
  { routeKey: 'foundation-synthesis-openclaw-chatgpt', acceptedStatuses: ['available', 'probe_required', 'blocked'], policyClassification: ['allowed', 'experimental'] },
  { routeKey: 'foundation-synthesis-claude-code', acceptedStatuses: ['probe_required', 'blocked'], policyClassification: 'experimental' },
  { routeKey: 'foundation-agent-claude-code', acceptedStatuses: ['probe_required', 'blocked'], policyClassification: 'experimental' },
...
export function buildLlmAuthAuditStatus({
  ...
  const latestRuns = asList(foundationJobs.latestRuns)
  const latestJob = latestRuns.find(run => run.jobKey === LLM_AUTH_AUDIT_JOB_KEY) || null
