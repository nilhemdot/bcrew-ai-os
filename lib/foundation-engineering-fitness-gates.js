...
export function evaluateFoundationLazySurfaceRouteLoadingArchitecture({
  ...
  add(/fetchFoundationBacklog\s*\(/.test(backlogRender) && !backlogRender.includes('fetchFoundationHub()'), 'backlog_still_uses_broad_hub', 'Backlog render must fetch the backlog route, not default Hub')
