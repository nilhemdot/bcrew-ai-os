...
export const FOUNDATION_LAZY_SURFACE_LOADING_CLOSEOUT_PATH = 'docs/handoffs/2026-05-17-foundation-lazy-surface-loading-closeout.md'
...
export function buildFoundationLazySurfaceLoadingDogfoodProof() {
  const goodPayloads = {
    backlog: {
      ...
      summary: { totalItems: 1, doneItems: 0, activeItems: 1 },
