...
const BROWSER_CHALLENGE_RE = /\b(just a moment|checking your browser|checking browser|enable javascript and cookies|cloudflare|attention required|verify you are human|captcha)\b/i
...
export function evaluateSourceBrowserPageHealth(snapshot = {}) {
  ...
  if (BROWSER_CHALLENGE_RE.test(surface)) {
    findings.push({
