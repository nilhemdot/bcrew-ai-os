...
function buildHtmlEmailRaw({ from, to, cc = '', replyTo = '', subject, text, html, fromName = '' }) {
...
export async function sendGmailMessage(userEmail, { to, cc = '', replyTo = '', subject, text, html, fromName = 'Benson Crew' } = {}) {
