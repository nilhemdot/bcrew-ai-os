...
export function evaluateSourceBrowserAgentHarness(snapshot = buildSourceBrowserAgentHarnessSnapshot()) {
  ...
  for (const ref of [AGENT_CAPABILITY_REGISTRY_CARD_ID, AGENT_TEMPLATE_RUNTIME_CONTRACT_CARD_ID, SOURCE_SESSION_BROKER_CARD_ID, SOURCE_GOD_MODE_EXTRACTOR_RUNTIME_CARD_ID, LOCAL_VIRTUAL_BROWSER_HANDS_CARD_ID]) {
