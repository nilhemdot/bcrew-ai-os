    ...
    return {
      ...
      recoveryPolicy: {
        ...
        humanEscalation: {
          ...
          channel: 'operator_ai_assistant_texting_lane',
...
function buildSourceBrowserOperatorEscalation({
  ...
  return {
    ...
    plainEnglish: 'Operator escalation packet is prepared through the Harlan auth-needed contract, but no text/email/message is sent from this proof path.',
  }
}
