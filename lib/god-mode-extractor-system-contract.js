...
export const GOD_MODE_EXTRACTOR_SOURCE_SOPS = [
  {
    ...
    steps: [
      'Every approved creator gets one source stack row/card that shows every known surface: YouTube, blog/site, newsletter, GitHub/docs/resources, free Skool/community, paid Skool/course, and other approved resources.',
