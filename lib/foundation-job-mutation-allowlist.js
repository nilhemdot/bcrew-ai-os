...
export const FOUNDATION_JOB_MUTATION_ALLOWLIST = Object.freeze({
  ...
  'nightly-audit-fleet': allowScheduled('read_only', 'Scheduled specialist audit fleet runs deterministic registry proof only; it writes no reports, backlog cards, sprint truth, source systems, provider config, browser state, or external systems.'),
  ...
  'generated-artifact-closeout': allowScheduled('external_write', 'Generated artifact closeout may commit and push only allowlisted generated report artifacts after proving main is synced and no other worktree changes exist. It must not create backlog cards, change sprint truth, or stage normal code/docs.'),
  ...
  'youtube-god-mode-autonomous-watch-scheduler': allowScheduled('operational_write', 'Steve approved the public YouTube live-bounded watcher operating posture on 2026-05-26. The scheduled job may spend Gemini budget only within explicit command caps, process approved public/no-auth YouTube videos through the guarded full-watch runner, persist governed intelligence artifacts, and refresh Director/source grades/Dev Hub. It must not use auth, comments, paid/private sources, purchases, downloads, forms, credential mutation, external writes, or automatic backlog promotion.'),
  'source-god-mode-youtube-handoff': allowScheduled('operational_write', 'YouTube-discovered public/free source handoff may run bounded source-browser/repo reads and persist governed source-crawl evidence only. It must not use auth unless the source-session broker marks the row ready, submit forms, buy, download, post/comment/message, mutate credentials, use a normal Chrome profile, call providers, or auto-promote backlog/Scoper work.'),
