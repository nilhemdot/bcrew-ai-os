...
function buildHistoricalIntelligenceSpineFacadeSource(source = '') {
  const text = String(source || '')
...
export function evaluateFoundationIntelligenceSpineVerifier(input = {}) {
  const checks = []
  const foundationDbSource = buildHistoricalIntelligenceSpineFacadeSource(input.foundationDbSource || '')
  const foundationDbWithBacklogSeedSource = buildHistoricalIntelligenceSpineFacadeSource(input.foundationDbWithBacklogSeedSource || foundationDbSource)
