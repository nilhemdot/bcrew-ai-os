...
export const VERIFIER_CANVA_CLIENT_ORCHESTRATION_SPLIT_HANDOFF_PATH = 'docs/_archive/handoffs/2026-05-19-hot-doc-cleanup/2026-05-17-verifier-canva-client-orchestration-split-closeout.md'
...
export async function evaluateFoundationCanvaClientVerifierOrchestration(input = {}) {
  ...
  const canvaClientSplitCloseoutOk = !verifierCanvaClientSplitModuleClosed || (
    ...
    await repoFileExists('docs/_archive/handoffs/2026-05-19-hot-doc-cleanup/2026-05-16-verifier-canva-client-split-module-closeout.md')
  )
