export const backlogSeedChunk005 = [
    ...
    },
  {
      ...
      nextAction: 'Expose packet intent, risk, next action, and source boundary before any crawl, login, purchase, or community read.',
      statusNote: 'V1.2 proof exists for packet classification, durable approval decisions, and an exact public-page local Playwright runtime plan. Missing: a worker runner that consumes approved decisions, persists extraction artifacts, and triggers freshness/status updates without broad crawling.',
    },
  {
