export const backlogSeedChunk005 = [
    ...
    },
  {
      ...
      nextAction: 'Create the implementation plan and focused proof for the guarded Hands run route/status UI on top of approved source-packet decisions and worker queue rows; keep Skool/MyICOR/private/auth blocked until Steve approves exact session/content packets.',
      statusNote: 'Scoped as the continuation after EXTRACTOR-HANDS-BROWSER-RUNTIME-001. Must reuse lib/extractor-hands-browser-runtime.js, lib/source-packet-worker-runner.js, existing decision ledger/queue routes, and Foundation artifact persistence. Required proof: add a focused process check that dogfoods a production-safe approved public/free packet run with status/readback/artifact persistence and proves no broad crawl, login, forms, downloads, purchases, external writes, or auto backlog writes.',
    },
  {
