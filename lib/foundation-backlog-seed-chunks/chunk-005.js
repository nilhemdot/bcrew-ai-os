export const backlogSeedChunk005 = [
    ...
    },
  {
      ...
      nextAction: 'Start with exact approved public source packets through SOURCE-PACKET-WORKER-RUNNER-001, then extend to logged-in Skool/MyICOR only after Steve approves source-specific session and content boundaries.',
      statusNote: 'Promoted from full raw conversation review. Scope is source-packet-bounded browser Hands, not broad crawling. Partial exact-public Playwright runtime exists in lib/source-packet-public-web-runtime.js, but full Hands is not built. Acceptance/proof must show approved exact URL navigation, bounded click policy, evidence capture, and fail-closed auth/form/download boundaries. Local Playwright-first only; no Browserbase/hosted fallback unless local reliability fails and Steve explicitly approves spend/tooling.',
    },
  {
