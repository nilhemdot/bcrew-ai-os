export const backlogSeedChunk005 = [
    ...
    },
  {
      ...
      nextAction: 'Keep batches bounded, public, no-auth, no external writes, and use the long-course lane for multi-hour course videos.',
      statusNote: 'V1 proof exists. This live card preserves the current-plan reference so active docs do not point at phantom work.',
    },
  {
      ...
      nextAction: 'Use resolver output as Scoper input and keep unsafe or auth-required links in explicit approval/source-packet states.',
      statusNote: 'V1 proof exists and remains proposal-only/read-only by default.',
    },
  {
      ...
      nextAction: 'Keep routing read-only and feed the Dev Intelligence Director only with system/build signals that match the AIOS mission.',
      statusNote: 'V1 proof exists and keeps Mark/full-watch Build Intel above weaker internal-source signals when warranted.',
    },
  {
      ...
      nextAction: 'Keep Skool, MyICOR, GitHub, public communities, Drive/course docs, and system-signal gaps visible until source packets or connectors are approved.',
      statusNote: 'V1 proof exists as a read-only source-family matrix.',
    },
  {
      ...
      nextAction: 'Use enough full-watch evidence before throttling or killing a source, and keep lane-specific value separate.',
      statusNote: 'V1 report/proof exists and does not mutate watchlists or promote build work automatically.',
    },
  {
