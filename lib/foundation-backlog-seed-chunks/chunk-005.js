export const backlogSeedChunk005 = [
    ...
    },
  {
      ...
      statusNote: 'Scoped P0 with proof required before build: use docs/process/god-mode-extractor-parity-gate-001-plan.md, add a focused npm run check, and do not close until the verifier proves no source can claim God Mode while comments, hands, resource-link, source-packet, or evidence fields are missing.',
    },
  {
      ...
      statusNote: 'Planned P0. Manual comment evidence is not enough; needs governed extractor proof.',
    },
  {
    ...
    },
  {
      ...
      statusNote: 'Scoped P0 with proof required before build: use docs/process/source-family-god-mode-extractors-001-plan.md, add a focused npm run check, and do not close until each source family has capability level, model/brain route, blockers, next card, and verifier-backed no-fake-God-Mode coverage.',
    },
  {
