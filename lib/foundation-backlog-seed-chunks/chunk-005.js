export const backlogSeedChunk005 = [
    ...
    },
  {
      ...
      nextAction: 'Turn the parity definition into a gate before calling any source family fully caught up.',
      statusNote: 'Scoped P0 with proof now started: use docs/process/god-mode-extractor-parity-gate-001-plan.md and npm run process:god-mode-extractor-parity-gate-check -- --json. Do not close until the verifier proves no source can claim God Mode while comments, hands, resource-link, source-packet, or evidence fields are missing.',
    },
  {
      id: 'YOUTUBE-PUBLIC-COMMENTS-EXTRACTOR-001',
      title: 'Add public YouTube comments to God Mode extraction',
      team: 'foundation',
      lane: 'scoped',
      priority: 'P0',
      rank: 17,
      source: 'Steve May 24-25 comment validation correction',
      summary: 'Capture approved public comments for exact videos as additional evidence, validation, objections, and implementation clues.',
      whyItMatters: 'Important signals can live in comments, including corrections, code links, creator clarifications, and community validation.',
      nextAction: 'Build a no-auth, exact-video, public-comments-only lane with link classification and evidence provenance.',
      statusNote: 'V1 governed proof exists: npm run process:youtube-public-comments-extractor-check -- --json. It proves exact-video/no-auth boundaries, comment provenance, source-packet classification for comment links, and a YouTube Data API public-comment adapter that blocks without YOUTUBE_DATA_API_KEY/YOUTUBE_API_KEY. Still needs API key config and runner integration before normal YouTube batches can claim comment support.',
    },
  {
      ...
      statusNote: 'V1 proof exists for packet classification; UI approval/chat workflow remains next.',
    },
  {
      ...
      nextAction: 'Use source value grades to prioritize S/A creators, selective B creators, and reduce C/D watch depth after baseline proof.',
      statusNote: 'Planned P0 catch-up lane. Standard public full-watch batches are active; parity gaps still apply.',
    },
  {
      ...
      summary: 'Show and improve God Mode maturity for YouTube, comments, long courses, GitHub, Skool, MyICOR, Drive/Meet training, Gmail/Missive, Slack, meetings, and system signals.',
    ...
    },
  {
      ...
      nextAction: 'Implement the report-only fleet registry and rollup from `docs/process/nightly-audit-fleet-001-plan.md`. Keep deterministic/no-spend mode first; route any LLM/deep-review lane through the LLM router with explicit model, effort, budget, and no-auto-fix boundaries.',
      statusNote: 'Scoped P0 with proof required before build: use docs/process/nightly-audit-fleet-001-plan.md, add a focused npm run check, and do not close until the report-only fleet registry proves hardcoded truth, extractor parity, synthesis/director quality, source freshness, UI/style, process/write-boundary, and mission-doctrine lanes without auto-fix or auto-created cards.',
    }
]
