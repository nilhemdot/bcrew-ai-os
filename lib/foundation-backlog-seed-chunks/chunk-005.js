export const backlogSeedChunk005 = [
    ...
    },
  {
      ...
      nextAction: 'Implement the freshness trigger and proof from `docs/process/synthesis-router-freshness-trigger-001-plan.md`. Keep failed extractors as blockers, debounce synthesis refreshes, and never auto-write backlog/decision/task ledgers.',
      statusNote: 'V1 proof exists: npm run process:synthesis-router-freshness-trigger-check -- --json. It proves stale/blocked/fresh/action-router states, runtime hook metadata patching, and live Foundation job ledger freshness. Autorun remains explicit via SYNTHESIS_FRESHNESS_TRIGGER_AUTORUN=true.',
    },
  {
