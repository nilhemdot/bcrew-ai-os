export const backlogSeedChunk005 = [
    ...
    },
  {
      ...
      nextAction: 'Build npm run process:source-packet-worker-runner-check -- --json around the existing source-packet public web runtime and prove decision -> runner -> artifact -> freshness/status loop.',
      statusNote: 'Promoted from the May 25-26 conversation and V1 synthetic proof now exists through npm run process:source-packet-worker-runner-check -- --json. Current proof is exact URL only and report-only: no link following, clicks, auth, forms, downloads, purchases, external writes, or auto backlog cards. Discovered links become new source-packet candidates. Live DB/artifact persistence remains next.',
    },
  {
