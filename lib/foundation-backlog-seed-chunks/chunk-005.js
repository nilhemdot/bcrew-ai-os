export const backlogSeedChunk005 = [
    ...
    },
  {
      ...
      nextAction: 'Use source value grades to prioritize S/A creators, selective B creators, and reduce C/D watch depth after baseline proof. Do not wait on comments; focus catch-up on video/audio/visual, resource packets, Hands status, and freshness.',
      statusNote: 'Planned P0 catch-up lane. Standard public full-watch batches are active; browser Hands/source-packet/resource gaps still apply. YouTube comments are operator-excluded.',
    },
  {
