export const backlogSeedChunk005 = [
    ...
    },
  {
      ...
      nextAction: 'Wire the V1 report-only fleet registry into the 3 AM/morning audit rollup without auto-fix, auto-created cards, live extraction, external writes, or unbudgeted LLM spend.',
      statusNote: 'V1 deterministic registry proof exists through npm run process:nightly-audit-fleet-check -- --json. It proves specialist lanes for hardcoded truth/runtime config, extractor parity, synthesis/director quality, source freshness, UI/style, process/write-boundary, and mission-doctrine with no-auto-fix/no-auto-card boundaries. 3 AM scheduler/rollup integration remains next.',
    }
]
