    ...
    return withFoundationTransaction(async client => {
      ...
      const result = await client.query(
        `
          ...
          VALUES ($1,$2,$3,'proposed',$4,$5,$6,$7,$8,$9,$10,$11,NOW(),$12,$13,COALESCE($14::timestamptz,NOW()),$15::timestamptz,$16)
          RETURNING *
        `,
        [
          id,
      ...
      const result = await client.query(
        `
          ...
          SET category = $2,
              ...
              context_ref = $13,
              evidence_notes = $14,
              valid_from = COALESCE($15::timestamptz, valid_from, classified_at, created_at),
              valid_until = $16::timestamptz,
              superseded_by = $17,
              updated_at = NOW()
          WHERE id = $1
          RETURNING *
