...
export const FOUNDATION_BUILD_CLOSEOUT_OVERNIGHT_RECORDS_DATA_PATH = 'data/foundation-build-closeouts/overnight-records.json'
...
export const FOUNDATION_BUILD_LOG_REGISTRY_SOURCE_PATHS = [
  ...
  FOUNDATION_BUILD_CLOSEOUT_OVERNIGHT_RECORDS_DATA_PATH,
