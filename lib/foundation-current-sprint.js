  ...
  return {
    sprint: {
      ...
      metadata: {
        ...
        currentStatus: 'scoping_plan_critic_replacement',
        nextAction: 'REBUILD-PLAN-RECONCILE-001 is done for v1. Pull PLAN-CRITIC-REPLACEMENT-001 next before closing the verifier behavior sweep.',
