  ...
  return {
    sprint: {
      ...
      metadata: {
        ...
        currentStatus: 'scoping_strategy_hub_meeting_ready',
        nextAction: 'VERIFIER-BEHAVIOR-SWEEP-001 is done for v1. Pull STRATEGY-HUB-MEETING-READY-001 next to prove one owner-only Strategy operator workflow.',
