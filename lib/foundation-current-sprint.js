  ...
  return {
    sprint: {
      ...
      metadata: {
        ...
        currentStatus: 'scoping_avatar_import',
        nextAction: 'STRATEGY-HUB-MEETING-READY-001 is done for v1. Pull AVATAR-IMPORT-001 next as the cheap old-system data carry-forward.',
