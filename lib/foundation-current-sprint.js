  ...
  return {
    sprint: {
      ...
      metadata: {
        ...
        currentStatus: 'scoping_rebuild_plan_reconcile',
        nextAction: 'VERIFY-GATE-TIERING-001 is done for v1. Pull REBUILD-PLAN-RECONCILE-001 next, then PLAN-CRITIC-REPLACEMENT-001 before closing the verifier behavior sweep.',
