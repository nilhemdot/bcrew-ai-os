  ...
  return {
    sprint: {
      ...
      metadata: {
        ...
        currentStatus: 'scoping_security_behavior_proof',
        nextAction: 'PLAN-CRITIC-REPLACEMENT-001 is done for v1. Pull SECURITY-BEHAVIOR-PROOF-001 next to prove live route behavior before verifier cleanup and Strategy Hub work.',
