  ...
  return {
    sprint: {
      ...
      metadata: {
        ...
        currentStatus: 'scoping_auto_deploy_rollback',
        nextAction: 'AVATAR-IMPORT-001 is done for v1. AUTO-DEPLOY-ROLLBACK-001 is now the next scoped reliability card; size it before any build.',
    ...
    items: [
      ...
      },
      {
        ...
        order: 8,
        stage: 'scoping',
        planRef: 'docs/process/auto-deploy-rollback-001-plan.md',
        definitionOfDone: 'Mac mini deploy reliability is scoped before build: push/pull/build/restart/health-check flow has a rollback plan and behavior proof target.',
        proofCommands: [
          'npm run backlog:hygiene -- --json',
          'npm run foundation:verify',
        ],
        ...
        metadata: {
          ...
          note: 'This is scoped next because Strategy and Avatar carry-forward are now closed; do not build it without its own 9.8 plan.',
        },
      },
    ],
  }
