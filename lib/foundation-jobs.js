const foundationJobDefinitions = [
  ...
  },
  {
    ...
    budget: 'llm_limited',
    command: 'npm',
    args: ['run', 'gmail:extract-candidates', '--', '--onlyWithoutCandidates=true', '--limit=15'],
    sourceIds: ['SRC-GMAIL-001'],
    ...
    nextAction: 'Run manually for one bite; schedule after provenance, content-hash processing, subscription route, and output quality are accepted.',
  },
  {
    ...
    budget: 'llm_limited',
    command: 'npm',
    args: ['run', 'missive:extract-candidates', '--', '--onlyWithoutCandidates=true', '--limit=15'],
    sourceIds: ['SRC-MISSIVE-001'],
  ...
  },
  {
    ...
    budget: 'llm_limited',
    command: 'npm',
    args: ['run', 'meeting-notes:extract-candidates', '--', '--onlyWithoutCandidates=true', '--limit=15'],
    sourceIds: ['SRC-MEETINGS-001'],
    description: 'Mines archived meeting transcripts without a successful processing run for the current content hash, one bounded LLM bite at a time.',
    nextAction: 'Run manually for one bite; schedule after provenance, content-hash processing, subscription route, and output quality are accepted.',
  },
  {
  ...
  },
  {
    ...
    runtimeMode: 'manual',
    scheduleEveryMinutes: null,
    maxRuntimeSeconds: 6000,
    budget: 'llm_limited',
    command: 'npm',
    args: ['run', 'shared-comms:intelligence-bite'],
    sourceIds: ['SRC-GMAIL-001', 'SRC-MISSIVE-001', 'SRC-MEETINGS-001', 'SRC-SLACK-001'],
    description: 'Runs one bounded Gmail, Missive, and meeting-transcript candidate bite, then records a fresh synthesis brief.',
    nextAction: 'Use manually only after a subscription route is executable, or with an explicit paid API override.',
  },
  {
