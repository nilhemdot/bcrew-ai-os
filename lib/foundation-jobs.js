...
const foundationJobDefinitions = [
  ...
  },
  {
    ...
    title: 'Agent Feedback Reminder Cadence Readiness',
    ...
    budget: 'connector',
    command: 'npm',
    args: ['run', 'agent-feedback:reminders', '--', '--mode=dry-run'],
    sourceIds: ['SRC-CLICKUP-001'],
    servesHubs: ['ops'],
    systemSummary: 'Reports onboarding feedback reminder readiness after an initial request is successfully marked Requested, without sending Gmail or writing ClickUp.',
    ...
    systemOutputs: ['Metadata-only pending/sent/skipped/blocked/maxed-out/repair reminder counts', 'Runtime Health/Ops readiness proof', 'No raw emails, token URLs, or feedback content'],
    description: 'Runs the governed Agent Onboarding Feedback reminder cadence scanner in dry-run/report mode.',
    nextAction: 'Keep reminder sends disabled until Steve approves the full-loop test. No reminder can run before a successful initial request exists.',
  },
  {
