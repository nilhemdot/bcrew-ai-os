const foundationJobDefinitions = [
  ...
  },
  {
    ...
    nextAction: 'Keep manual until channel scope, rate limits, and per-channel cursor behavior are proven.',
  },
  {
    ...
    budget: 'llm_limited',
    command: 'npm',
    args: ['run', 'slack:extract-candidates', '--', '--limit=1'],
    sourceIds: ['SRC-SLACK-001'],
    ...
    nextAction: 'Run manually as a paced subscription miner; schedule only after route latency, spacing, and cancellation behavior are proven.',
  },
  {
    ...
    lane: 'archive',
    priority: 'P1',
    cadence: 'manual daily mission: one folder inventory bite now, five filed extractions later',
    enabled: true,
    runtimeMode: 'manual',
    scheduleEveryMinutes: null,
    maxRuntimeSeconds: 3900,
    ...
    nextAction: 'Keep as a quota mission, not a timer; later file about five Drive extraction outputs per day after inventory/review semantics are proven.',
  },
  {
