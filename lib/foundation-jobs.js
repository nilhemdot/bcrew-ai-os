const foundationJobDefinitions = [
  ...
  },
  {
    ...
    servesHubs: ['ops'],
    systemSummary: 'Rebuilds the Owners Dashboard Listings and Conditional Deals tab from ClickUp Deal Data Entry conditional tasks. Buyer/seller conditional tags determine the lane; mutual-release tags are excluded as dead deals. The generated sheet preserves a Review This Conditional action for fixed rows that need a re-check.',
    ...
    nextAction: 'Use the preserved Review This Conditional action for missing-data re-checks; build deeper FUB/conditional parity only after Trade Number, closing date, expected team collection, and FUB link are maintained.',
  },
  {
    key: 'agent-roster-review',
    title: 'Agent Roster Inspection',
    jobType: 'review',
    lane: 'people',
    priority: 'P1',
    cadence: 'every 8 hours: inspect ClickUp Agent Roster accountability',
    enabled: true,
    runtimeMode: 'scheduled',
    scheduleEveryMinutes: 480,
    maxRuntimeSeconds: 300,
    ...
    servesHubs: ['ops'],
    systemSummary: 'Reads the ClickUp Agent Roster as the v1 people-accountability source, surfaces roster blockers, and writes onboarding-NPS form results back to the roster task status/score/feedback fields.',
    ...
    description: 'Keeps the agent roster accountable and mirrors private AIOS onboarding-feedback responses back into ClickUp result fields.',
