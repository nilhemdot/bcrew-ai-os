const foundationJobDefinitions = [
  ...
  },
  {
    ...
    servesHubs: ['ops'],
    systemSummary: 'Inspects queued closed/firm Owners deal rows against FUB joins and deal-quality rules. Scheduled mode is read-only; explicit writeback mode exists but is not scheduled.',
    systemInputs: ['SRC-OWNERS-001 Admin deal rows', 'SRC-FUB-001 person records', 'Queued review action cells'],
    systemOutputs: ['Ops inbox issue cards', 'Read-only inspection results', 'Foundation job run status'],
    description: 'Reads queued closed deals and FUB joins. Use explicit --write mode only after Ops approves sheet writeback.',
    nextAction: 'Foundation inspection is running. Sheet writeback is deliberately separate and approval-gated.',
  },
  {
    ...
    sourceIds: ['SRC-OWNERS-001', 'SRC-FUB-001'],
    servesHubs: ['ops'],
    systemSummary: 'Inspects queued conditional/listing rows against FUB identity, stage, agent, and address parity. Scheduled mode is read-only; explicit writeback mode exists but is not scheduled.',
    systemInputs: ['Listings and Conditional Deals rows', 'SRC-FUB-001 person records', 'Queued conditional review action cells'],
    systemOutputs: ['Ops inbox issue cards', 'Read-only inspection results', 'Foundation job run status'],
    description: 'Reads queued conditional/listing rows and FUB joins. Use explicit --write mode only after Ops approves sheet writeback.',
    nextAction: 'Foundation inspection is running. Sheet writeback is deliberately separate and approval-gated.',
  },
  {
