const foundationJobDefinitions = [
  ...
  },
  {
    ...
    lane: 'transactions',
    priority: 'P1',
    cadence: 'every 6 hours: queued re-reviews first, then one backlog deal',
    enabled: true,
    runtimeMode: 'scheduled',
    ...
    servesHubs: ['ops'],
    systemSummary: 'Inspects queued Admin deal re-reviews first, then one never-inspected closed/firm Owners deal from the June 2025 merger backlog. Scheduled writeback only populates AI review status, action, and findings; it does not auto-fix source fields.',
  ...
  },
  {
    ...
    lane: 'transactions',
    priority: 'P1',
    cadence: 'every 6 hours: queued re-reviews first, then one backlog row',
    enabled: true,
    runtimeMode: 'scheduled',
    scheduleEveryMinutes: 360,
    maxRuntimeSeconds: 600,
    ...
    sourceIds: ['SRC-OWNERS-001', 'SRC-FUB-001'],
    servesHubs: ['ops'],
    systemSummary: 'Inspects queued conditional/listing re-reviews first, then one never-inspected conditional row from the June 2025 merger backlog. Scheduled writeback only populates AI review status, action, and findings; it does not auto-fix source fields.',
