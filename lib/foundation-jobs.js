const foundationJobDefinitions = [
  ...
  },
  {
    ...
    sourceIds: ['SRC-GMAIL-001'],
    description: 'Extracts governed candidates from archived Gmail threads that do not yet have active candidates.',
    nextAction: 'Run manually for one bite; schedule only after router/cost telemetry and output quality are accepted.',
  },
  {
    ...
    sourceIds: ['SRC-MISSIVE-001'],
    description: 'Extracts governed candidates from archived Missive conversations that do not yet have active candidates, including internal comments.',
    nextAction: 'Run manually for one bite; schedule only after router/cost telemetry and output quality are accepted.',
  },
  {
  ...
  },
  {
    ...
    sourceIds: ['SRC-MEETINGS-001'],
    description: 'Mines archived meeting transcripts that do not yet have active candidates, one bounded LLM bite at a time.',
    nextAction: 'Run manually for one bite; schedule only after router/cost telemetry and output quality are accepted.',
  },
  {
