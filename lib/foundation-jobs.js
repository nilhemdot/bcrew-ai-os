const foundationJobDefinitions = [
  ...
  },
  {
    ...
    budget: 'llm_limited',
    command: 'npm',
    args: ['run', 'gmail:extract-candidates', '--', '--onlyWithoutCandidates=true', '--limit=5'],
    sourceIds: ['SRC-GMAIL-001'],
    ...
    nextAction: 'Run manually for one small proof bite; raise the limit only after daily route latency is stable.',
  },
  {
    ...
    budget: 'llm_limited',
    command: 'npm',
    args: ['run', 'missive:extract-candidates', '--', '--onlyWithoutCandidates=true', '--limit=5'],
    sourceIds: ['SRC-MISSIVE-001'],
  ...
  },
  {
    ...
    budget: 'llm_limited',
    command: 'npm',
    args: ['run', 'shared-comms:intelligence-bite', '--', '--skipMeetings=true'],
    sourceIds: ['SRC-GMAIL-001', 'SRC-MISSIVE-001', 'SRC-MEETINGS-001', 'SRC-SLACK-001'],
    description: 'Runs one bounded Gmail and Missive candidate bite, then records a fresh synthesis brief. Meeting transcript backlog mining is a separate long-window subscription job.',
    nextAction: 'Run 2 monitored parent-job proofs on the fast path; schedule daily only after no stale llm_calls, no orphan OpenClaw processes, and complete route provenance.',
  },
  {
