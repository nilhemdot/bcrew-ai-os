const foundationJobDefinitions = [
  ...
  },
  {
    ...
    sourceIds: ['SRC-GDRIVE-001'],
    description: 'Extracts Google Docs, PDFs, and plain text files from the Drive inventory queue into source-backed artifacts with file provenance.',
    nextAction: 'Run as a small daily quota mission. Add Slides, Sheets, Office, images, and video through explicit follow-on extractors with skip reasons.',
  },
  {
  ...
  },
  {
    ...
    budget: 'llm_limited',
    command: 'npm',
    args: ['run', 'intelligence:synthesis-proof'],
    sourceIds: ['SRC-GMAIL-001', 'SRC-MISSIVE-001', 'SRC-MEETINGS-001', 'SRC-SLACK-001'],
    ...
    nextAction: 'Use as the v1 scheduled refresh lane until the proof command is split into smaller production jobs.',
  },
  {
    ...
    budget: 'no_llm',
    command: 'npm',
    args: ['run', 'intelligence:action-router-proof'],
    sourceIds: ['SRC-GMAIL-001', 'SRC-MISSIVE-001', 'SRC-MEETINGS-001', 'SRC-SLACK-001'],
