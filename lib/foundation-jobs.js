const foundationJobDefinitions = [
  ...
  },
  {
    ...
    nextAction: 'Run manually one transcript at a time; this is the deep miner, not the fast daily brief path.',
  },
  {
  ...
  },
  {
    ...
    title: 'Shared Comms Intelligence Bite',
    jobType: 'intelligence_bite',
    lane: 'synthesis',
    priority: 'P0',
    cadence: 'manual after source syncs or before strategy prep',
    enabled: true,
    runtimeMode: 'manual',
    scheduleEveryMinutes: null,
    maxRuntimeSeconds: 3900,
    ...
    sourceIds: ['SRC-GMAIL-001', 'SRC-MISSIVE-001', 'SRC-MEETINGS-001', 'SRC-SLACK-001'],
    description: 'Records a fresh synthesis brief from already-mined shared-comms candidates. Extraction miners run separately so slow subscription calls do not block the brief.',
    nextAction: 'Run monitored synthesis-only proofs; schedule daily only after the brief path stays clean and background miners feed it reliably.',
  },
  {
    ...
    nextAction: 'Run monitored subscription-route proofs with the long synthesis timeout, then make this the first recurring intelligence brief job.',
  },
]
