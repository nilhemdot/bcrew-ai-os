...
export function extractMeetingRawFileRefsFromArtifact(artifact = {}) {
  ...
  const base = {
    ...
    artifactUpdatedAt: artifact.artifactUpdatedAt || metadata.artifactUpdatedAt || null,
    ingestedAt: artifact.ingestedAt || metadata.ingestedAt || null,
    updatedAt: artifact.updatedAt || metadata.updatedAt || null,
  }
