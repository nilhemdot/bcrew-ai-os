...
export const GEMINI_VIDEO_BRAIN_ROUTE_CLOSEOUT_PATH = 'docs/_archive/handoffs/2026-05-20-gemini-video-brain-route-closeout.md'
...
export const GEMINI_VIDEO_CANDIDATE_MODEL = process.env.LLM_GEMINI_VIDEO_CANDIDATE_MODEL || 'gemini-3.5-flash'
export const GEMINI_VIDEO_FULL_WATCH_MODEL = process.env.LLM_GEMINI_VIDEO_FULL_WATCH_MODEL || GEMINI_VIDEO_CANDIDATE_MODEL
