...
export function buildDevIntelSourceCoverageSnapshot({ generatedAt = new Date().toISOString() } = {}) {
  const rows = [
    ...
    family({
      ...
      nextAction: 'Show every creator surface in one creator card: YouTube, blog/site, newsletter, GitHub/docs/resources, free Skool/community, paid Skool/course/training platforms, and other approved sources.',
