...
function refreshBuildLaneFailureSummaryAfterShipProof(repoRoot) {
  try {
    ...
    // Ship proof remains the source of truth; summary refresh is best-effort local telemetry.
  }
}
...
export async function recordFoundationShipProof({
  ...
  refreshBuildLaneFailureSummaryAfterShipProof(root)
  return nextProof
}
