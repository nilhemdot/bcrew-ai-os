...
export async function runPrePushHook({
  ...
  return {
    ...
    mode: 'pre-push',
    protectedFiles,
    message: 'Protected Foundation paths changed. Run process:foundation-ship for the ship, or set FOUNDATION_HOOK_BYPASS_REASON and FOUNDATION_HOOK_BYPASS_CARD for an explicit bypass.',
  }
}
