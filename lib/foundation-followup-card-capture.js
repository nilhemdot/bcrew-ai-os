...
import { readFoundationBacklogSeedSourceBundle } from './foundation-backlog-seed-source.js'
...
export const FOUNDATION_FOLLOWUP_CARD_CAPTURE_AUDIT_PATH = 'docs/_archive/audits/2026-04-30-foundation-followup-card-capture.md'
...
export async function buildFoundationFollowupCardCaptureStatus({
  ...
  const backlogSeedSource = await readFoundationBacklogSeedSourceBundle({
    readRepoFile: relativePath => readOptionalText(repoRoot, relativePath),
  })
  const seedSource = [
