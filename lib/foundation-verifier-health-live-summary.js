...
export async function evaluateFoundationVerifierHealthLiveSummary(input = {}) {
  ...
  const systemHealthNightlyRuntime = getFoundationJobRuntime(systemHealthNightlyJob || {}, {
    ...
    'SYSTEM-HEALTH-NIGHTLY-AUDIT-001, SCHEDULED-JOB-STALENESS-DASHBOARD-001, BUILD-LANE-FAILURE-TELEMETRY-001, and BUILD-LANE-REPEATED-FAILURE-ACTION-GATE-001 surface and route hidden job/source/system/build-lane staleness',
