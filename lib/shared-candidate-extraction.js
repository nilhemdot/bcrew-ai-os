...
export async function extractSharedCandidatesWithOpenAi({
  ...
  assertDirectOpenAiResponsesAllowed({ workload: 'shared communication extraction' });

  if (!process.env.OPENAI_API_KEY) {
    throw new Error('OPENAI_API_KEY is required for shared communication extraction.');
  }
