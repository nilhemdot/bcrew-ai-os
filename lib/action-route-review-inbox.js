...
export const ACTION_ROUTE_REVIEW_INBOX_CLOSEOUT_PATH = 'docs/handoffs/2026-05-18-action-route-review-inbox-closeout.md'
...
export function buildActionRouteReviewInboxSnapshot({
  ...
  return {
    ...
    source: {
      ...
      mutationRoutesOwnedByFollowups: true,
    },
    summary: {
