...
export const AGENT_FEEDBACK_COMPANY_EMAIL_POLICY_PROOF_PATH = 'docs/_archive/audits/2026-05-01-agent-feedback-company-email-policy-proof.md'
...
export async function buildAgentFeedbackCompanyEmailPolicyStatus({
  ...
  const closeout = findFoundationBuildCloseoutEntry(
    ...
    { backlogId: AGENT_FEEDBACK_COMPANY_EMAIL_POLICY_CARD_ID },
  )
  ...
  addFinding(findings, verifierCoverageSource.includes(AGENT_FEEDBACK_COMPANY_EMAIL_POLICY_CARD_ID), 'foundation verifier covers company-email policy card', AGENT_FEEDBACK_COMPANY_EMAIL_POLICY_CARD_ID)
