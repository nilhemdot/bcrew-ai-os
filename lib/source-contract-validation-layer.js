...
export const SOURCE_CONTRACT_VALIDATION_PROFILES = Object.freeze({
  ...
  'SRC-STRATEGY-QUARTER-001': profile({
    ...
    authPosture: 'no_auth_internal',
    extractionPosture: 'no_extraction_required',
    freshnessExpectation: freshness('source_owner_review', { maxAgeDays: 7, description: 'Refresh through Strategy Hub owner/admin quarter context review.' }),
    connectorStatus: 'not_applicable',
    atomFlowExpectation: 'eligible_now',
  }),
  ...
  'SRC-YOUTUBE-INTEL-001': profile({
    ...
    freshnessExpectation: freshness('read_only_reference', { description: 'Public YouTube creator metadata watch is active as proposal-only Build Intel; transcripts, screenshots, comments, member/community, paid/private, and Gemini video work remain separately scoped.' }),
    connectorStatus: 'working',
    connectorIds: ['CONN-DATAFORSEO-001'],
    atomFlowExpectation: 'proposal_only',
  }),
