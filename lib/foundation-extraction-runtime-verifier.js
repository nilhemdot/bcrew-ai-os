...
function buildHealthyFixture() {
  return {
    ...
    currentPlan: 'Corpus mission lane daily quota missions files the outputs with provenance source_crawl_target_runs crawlRunId',
    currentState: 'daily quota missions file outputs with provenance source_crawl_target_runs crawlRunId',
    ...
    packageSource: '"drive:inventory-links" "process:crawl-run-ledger-check": "node --env-file-if-exists=.env scripts/process-crawl-run-ledger-check.mjs"',
