...
import {
  FILE_SIZE_FINDING_KEYS,
  evaluatePlanFileSizeStandard,
...
export const ARCHITECTURAL_RULE_FINDING_KEYS = {
  ...
  fileSizeOverBudgetSplitPlan: FILE_SIZE_FINDING_KEYS.overBudgetSplitPlan,
  fileSizeExplicitArtifactBudget: FILE_SIZE_FINDING_KEYS.explicitArtifactBudget,
...
export function evaluatePlanCriticArchitecturalRules({
  ...
  const fileSizeStandard = evaluatePlanFileSizeStandard({
    planText,
    changedFiles: normalizedChangedFiles,
    fileLineCounts,
    repoRoot,
  })
  findings.push(...fileSizeStandard.findings)
