...
export async function evaluateFoundationServerRouteSplitVerifier(input = {}) {
  ...
  addCheck(
    ...
    fubCard &&
      ...
      await repoFileExists('docs/_archive/handoffs/2026-05-19-hot-doc-cleanup/2026-05-15-fub-source-route-split-closeout.md') &&
  ...
  addCheck(
    ...
    runtimeCard &&
      ...
      await repoFileExists('docs/_archive/handoffs/2026-05-19-hot-doc-cleanup/2026-05-15-foundation-runtime-read-routes-split-closeout.md') &&
  ...
  addCheck(
    ...
    appPageCard &&
      ...
      await repoFileExists('docs/_archive/handoffs/2026-05-19-hot-doc-cleanup/2026-05-15-app-page-routes-split-closeout.md') &&
  ...
  addCheck(
    ...
    authCard &&
      ...
      await repoFileExists('docs/_archive/handoffs/2026-05-19-hot-doc-cleanup/2026-05-15-auth-routes-split-closeout.md') &&
  ...
  addCheck(
    ...
    hubReadCard &&
      ...
      await repoFileExists('docs/_archive/handoffs/2026-05-19-hot-doc-cleanup/2026-05-15-hub-read-routes-split-closeout.md') &&
  ...
  addCheck(
    ...
    strategyCard &&
      ...
      await repoFileExists('docs/_archive/handoffs/2026-05-19-hot-doc-cleanup/2026-05-15-strategy-shared-comms-routes-split-closeout.md') &&
  ...
  addCheck(
    ...
    writeCard &&
      ...
      await repoFileExists('docs/_archive/handoffs/2026-05-19-hot-doc-cleanup/2026-05-15-foundation-write-routes-split-closeout.md') &&
  ...
  addCheck(
    ...
    feedbackCard &&
      ...
      await repoFileExists('docs/_archive/handoffs/2026-05-19-hot-doc-cleanup/2026-05-15-agent-feedback-routes-split-closeout.md') &&
