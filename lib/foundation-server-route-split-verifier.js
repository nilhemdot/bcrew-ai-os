...
export async function evaluateFoundationServerRouteSplitVerifier(input = {}) {
  ...
  addCheck(
    ...
    fubCard &&
      ...
      String(fubCard.statusNote || '').includes(FUB_SOURCE_ROUTE_SPLIT_CLOSEOUT_KEY) &&
  ...
  addCheck(
    ...
    runtimeCard &&
      ...
      String(runtimeCard.statusNote || '').includes(FOUNDATION_RUNTIME_READ_ROUTES_SPLIT_CLOSEOUT_KEY) &&
  ...
  addCheck(
    ...
    appPageCard &&
      ...
      String(appPageCard.statusNote || '').includes(APP_PAGE_ROUTES_SPLIT_CLOSEOUT_KEY) &&
  ...
  addCheck(
    ...
    authCard &&
      ...
      String(authCard.statusNote || '').includes(AUTH_ROUTES_SPLIT_CLOSEOUT_KEY) &&
  ...
  addCheck(
    ...
    hubReadCard &&
      ...
      String(hubReadCard.statusNote || '').includes(HUB_READ_ROUTES_SPLIT_CLOSEOUT_KEY) &&
      ...
      input.serverSource?.includes("app.post('/api/sales-hub/listing-assignment'") &&
  ...
  addCheck(
    ...
    strategyCard &&
      ...
      String(strategyCard.statusNote || '').includes(STRATEGY_SHARED_COMMS_ROUTES_SPLIT_CLOSEOUT_KEY) &&
  ...
  addCheck(
    ...
    writeCard &&
      ...
      String(writeCard.statusNote || '').includes(FOUNDATION_WRITE_ROUTES_SPLIT_CLOSEOUT_KEY) &&
  ...
  addCheck(
    ...
    feedbackCard &&
      ...
      String(feedbackCard.statusNote || '').includes(AGENT_FEEDBACK_ROUTES_SPLIT_CLOSEOUT_KEY) &&
