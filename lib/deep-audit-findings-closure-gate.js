...
export const DEEP_AUDIT_FINDING_ROUTES = Object.freeze([
  ...
  },
  {
    ...
    nextAction: 'Next active overnight card splits the Current State renderer without changing behavior.',
  },
  {
  ...
  },
  {
    ...
    nextAction: 'Create the source-owned admin deal policy date contract in the approved overnight order.',
  },
  {
    ...
    owner: 'Plan Critic',
    nextAction: 'Replace raw threshold literals with the shared approval threshold registry.',
  },
  {
    ...
    nextAction: 'Decide the next data-backed closeout source slice after the registry extract.',
  },
  {
    ...
    owner: 'Foundation Runtime',
    nextAction: 'Cache and slim the Build Log API in the approved overnight order.',
  },
  {
    ...
    owner: 'Build Intel',
    nextAction: 'Classify pinned Build Intel commits as snapshot evidence with freshness semantics.',
  },
  {
