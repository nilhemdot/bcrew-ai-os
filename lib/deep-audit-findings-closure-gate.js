...
export const DEEP_AUDIT_FINDINGS_CLOSURE_GATE_AUDIT_MD_PATH = 'docs/_archive/audits/2026-05-19-foundation-deep-merge-audit.md'
...
export const DEEP_AUDIT_FINDING_ROUTES = Object.freeze([
  ...
  },
  {
    ...
    targetCloseoutKey: 'focused-sprint-id-historical-aware-v1',
    coveredByCardId: 'SPRINT-CHECK-HISTORICAL-MODE-001',
    coveredByCloseoutKey: 'sprint-check-historical-mode-v1',
    owner: 'Foundation Process',
    nextAction: 'Covered by focused-sprint-id-historical-aware-v1; reopen only if focused checks named by audit refs again hard-fail on exact active sprint IDs after closeout rollover.',
  },
  {
    ...
    targetCloseoutKey: 'foundation-css-surface-decouple-v1',
    coveredByCardId: 'FOUNDATION-FRONTEND-DOM-BUDGET-001',
    coveredByCloseoutKey: 'foundation-frontend-dom-budget-v1',
    owner: 'Foundation Frontend',
    nextAction: 'Covered by foundation-css-surface-decouple-v1; reopen only if broad Foundation core/workflows CSS surfaces regain ownerless selectors or exceed the CSS ownership budgets again.',
  },
])
