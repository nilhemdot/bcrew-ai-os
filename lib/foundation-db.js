...
const backlogSeed = [
  ...
  },
  {
    ...
    nextAction: 'Keep the index generator authoritative, require a promoted-to target for evidence before build work depends on it, and keep verifier coverage on System Strategy / Rebuild Plan alignment so the active-doc set cannot drift silently.',
    statusNote: 'First slice done on 2026-04-25: indexes now include generated timestamps, promoted-to column, and no free-floating active-reference status. 2026-04-26 update added a verifier guard for System Strategy / Rebuild Plan alignment after the Systems page exposed plan drift.',
  },
  {
    id: 'DB-SEED-001',
