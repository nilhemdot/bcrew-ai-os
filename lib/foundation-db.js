...
const backlogSeed = [
  ...
  },
  {
    ...
    nextAction: 'Use `docs/source-notes/google-drive-corpus.md` as the first root list. Build a read-only direct-child inventory runner for one folder bite: root folder, folder cursor, file type, owner/account, modified time, inspected_at, action proposed, archive/mirror destination, extraction status, value route, sensitivity, skip reason, error, and next folder. No move/delete; copy or derivative course/content output only after approval.',
    statusNote: 'Source contract seed is `SRC-GDRIVE-001`. Eight shared-drive roots are captured. Do not ACL-strip originals in this phase; inventory, copy/mirror by approval, and classify first.',
  },
  {
