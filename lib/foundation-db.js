...
const backlogSeed = [
  ...
  },
  {
    ...
    statusNote: 'Closed on 2026-04-25 for v1 Admin deal-review enforcement. The Admin runner writes CC/CD/CE and now checks split math, governed source classification, company/agent expectation, FUB joins/source/stage/ISA evidence, and Freedom deal/NPS/Google-review follow-through. Conditional review has the matching S:U review lane but still needs row identity backfill through DATA-008-style cleanup.',
  },
  {
    id: 'DATA-007',
