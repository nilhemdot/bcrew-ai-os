...
const backlogSeed = [
  ...
  },
  {
    ...
    nextAction: 'Before coding, confirm the visible home. Recommended first surface: Foundation > Backlog or Foundation > Action Review, with links from Overview and Recent Work. Then ship pending-routes panel, one-click Approve/Reject, Apply confirmation with destination record ID/link, aged-route visibility, apply-success-rate verifier, and Recent Builds closeout.',
    statusNote: 'Next intended build after this capture pass. Scope is review-and-apply UX only. Not in scope: resolution-loop recurrence hardening, broad Strategy UI expansion, Scoper, Agent Factory, retry/backoff, or another corpus lane. Resolution hardening waits until enough routes move through review/apply to create signal.',
  },
  {
    id: 'VIDEO-001',
