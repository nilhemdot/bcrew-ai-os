...
const backlogSeed = [
  ...
  },
  {
    ...
    nextAction: 'Not next. Put this in Phase D cleanup. Before 2026-07-27, review each exception in `docs/process/verifier-exceptions.json` and decide: add real verifier coverage, retire/restructure the card, or re-approve with a fresh reason.',
    statusNote: 'Scoped during POST-SHIP-FAN-OUT-001. Deadline: 2026-07-27, which is 90 days after the 2026-04-28 exception approval timestamp. V1 is a backlog reminder only; exception cleanup is not part of Wave 3.',
  },
  {
  ...
  },
  {
    ...
    nextAction: 'Not next. Scope this during Phase C visibility work or the Phase E full re-audit. V1 should not read Steve’s external Google Doc until the import/permission boundary is explicit.',
    statusNote: 'Scoped during DOCTRINE-PROPAGATION-001 as a follow-up only. Do not build now. The current Wave 4 build records the drift class and keeps the hit list manual until a governed import/reconciliation surface exists.',
  },
  {
  ...
  },
  {
    ...
    nextAction: 'Not next. Keep this in Phase D or fold into FOUNDATION-SURFACE-UPDATES-001 when Recent Work UX is rebuilt.',
    statusNote: 'Scoped during SUB-SURFACE-MAPPING-001 / SYSTEM-INVENTORY-TRUE-UP-001. Phase C added the narrow API behavior needed for Recent Builds to expose multiple closeout records on one commit so fanout gates can pass. The broader UX/card closeout remains scoped for Phase D or FOUNDATION-SURFACE-UPDATES-001.',
  },
  {
    ...
    nextAction: 'Not next. Build only after Phase D cleanup ships clean.',
    statusNote: 'Scoped during PHANTOM-CARD-CHECK-001 because the command-order UI references the Phase E re-audit step and active references must point at real backlog cards.',
  },
  {
