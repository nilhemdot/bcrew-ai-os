...
const backlogSeed = [
  ...
  {
    id: 'AGENT-002',
    title: 'Build a leadership meeting copilot and strategy PM agent',
    team: 'dev',
    lane: 'research',
    priority: 'P1',
    rank: 29,
    source: 'Leadership meeting agent idea',
    summary: 'Create an agent that joins leadership and strategy meetings, keeps the room on agenda, asks follow-up questions, captures decisions, breaks next steps into backlog/work items, and tracks department follow-through.',
    whyItMatters: 'Steve should not have to both lead the business and act as the full-time strategy PM. A strong meeting copilot could protect cadence, improve accountability, and turn meeting output into structured follow-through.',
    nextAction: 'Define the MVP: meeting transcript capture, agenda enforcement, question prompts, decision extraction, owner/deadline tracking, backlog updates, and escalation rules when departments miss commitments.',
    statusNote: 'Start as a meeting copilot and strategy PM layer, not a fully autonomous meeting boss.',
  },
  {
    id: 'AGENT-003',
    title: 'Add voice-triggered live meeting activation for Harlan',
    team: 'dev',
    lane: 'research',
    priority: 'P1',
    rank: 30,
    source: 'Meeting copilot product idea',
    summary: 'Let Harlan join a Google Meet or strategy session as a live meeting copilot that can be activated by voice cues such as “Hey Harlan, kick us off” or “Hey Harlan, what are we missing?”',
    whyItMatters: 'If the meeting copilot can be activated naturally in the room, it becomes much easier to use for kickoff, agenda discipline, question prompting, note capture, and follow-through without turning the meeting into a manual operator workflow.',
    nextAction: 'Define the first live-meeting interaction model: wake phrase or push-to-talk trigger, Meet audio ingress, note-taking behavior, interruption rules, participant awareness, and when Harlan should speak versus stay silent.',
    statusNote: 'This is a layer on top of AGENT-002, not a replacement for the meeting copilot core.',
  },
  {
    id: 'STRATEGY-005',
