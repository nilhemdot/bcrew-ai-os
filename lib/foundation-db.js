...
const backlogSeed = [
  ...
  },
  {
    ...
    nextAction: 'Do not build yet. Position as Card 6.5 on the hit list before Wave 5 parallel ramp. Scope: cache sheet reads with configurable TTL, switch multi-range reads to batchGet, request quota increase, expose cache hit/miss and recent quota usage in Runtime Health, and add verifier warning when usage trends toward the limit.',
    statusNote: 'Scoped only during the Cards 1+2 verifier gate build. Visible home when built: Foundation > Runtime Health > Sheets API Trust. Not in scope for this slice: changing source contracts, changing business reads, bypassing live source truth, or masking real source failures as healthy.',
  },
  {
