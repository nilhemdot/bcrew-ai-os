...
const backlogSeed = [
  ...
  },
  {
    ...
    statusNote: 'V1 source boundary locked. Deal Data Entry has AIOS review fields for internal onboarding/deal-management surveys plus client NPS / Google-review workflow at the back of Full Deal List. Conditional forecast rebuilds from ClickUp. Admin review joins ClickUp by Deal # first, then property/address fallback so missing Trade Numbers become explicit findings. Agent Roster is live in Ops as a validation-only lane: contract-link, roster baseline backfill, onboarding NPS schedule initialization, reminder checks, and personal-email coverage.',
  },
  {
    id: 'SOURCE-005',
