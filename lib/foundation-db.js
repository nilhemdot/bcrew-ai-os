...
const backlogSeed = [
  ...
  },
  {
    ...
    statusNote: 'Delegated meeting-note reads now scan the enabled BCrew user list, detect standalone transcript docs or embedded transcript sections, and archive canonical meeting artifacts into PostgreSQL. The remaining work is governed approval/apply flow, privacy controls, and wider extraction depth, not basic access.',
  },
  {
    id: 'SOURCE-019',
  ...
  try {
    ...
    await client.query(
      ...
      [
        ...
        'Delegated meeting-note reads now scan the enabled BCrew user list, detect standalone transcript docs or embedded transcript sections, and archive canonical meeting artifacts into PostgreSQL. Remaining work is governed approval/apply flow, privacy controls, and wider extraction depth, not basic access.',
      ]
    )
