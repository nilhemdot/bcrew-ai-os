...
const backlogSeed = [
  ...
  },
  {
    ...
    nextAction: 'Plan and execute only after Company Email policy is accepted. Target Steve Zahnd only. Use ClickUp Company Email as To, BCC Steve/Carson/Ryan/Georgia with Steve deduped, one-send limit, Gmail success before ClickUp Requested, and roles/hashes in tracked proof.',
    statusNote: 'Scoped on 2026-05-01. Hard rules: no Georgia test, no production-all auto-send, no other roster sends, no live reminder unless separately approved, and no raw emails, private token URLs, or feedback text in tracked docs/build log. The test flow must prove Gmail message/thread proof, ClickUp Requested proof, DB response proof, ClickUp Completed/Score/Feedback proof, internal notification proof, reminder stop proof, duplicate resend prevention, foundation:verify, clean commit, and push.',
  },
  {
    ...
    summary: 'After the Steve full-loop test passes, enable production-all auto-send for eligible 30/60/90 onboarding feedback requests through the governed two-key approval path.',
    whyItMatters: 'The end state is a live daily Agent Roster scan that sends eligible onboarding feedback requests automatically, records proof, starts reminders when Requested remains incomplete, and notifies internal oversight after responses.',
    nextAction: 'Do not build until AGENT-FEEDBACK-STEVE-FULL-LOOP-TEST-001 is accepted. Start with dry-run production report, then enable production-all only after approval. Preserve Company Email only, BCC oversight, Gmail-before-Requested sequencing, duplicate protection, reminder cadence, response notification, and metadata-only broad proof.',
    statusNote: 'Scoped on 2026-05-01. Production behavior: daily scan of ClickUp Agent Roster, eligible 30/60/90 milestones send automatically, Company Email only, BCC Steve/Carson/Ryan/Georgia with dedupe, Gmail success before ClickUp Requested, duplicate ledger, reminder cadence active for Requested-but-not-completed, reminders stop when Completed/Skipped/Blocked, response notification active, and Runtime/Ops show sent/blocked/skipped/reminders/responses/repair states. No production-all enablement until separate approval.',
  },
  {
    ...
    whyItMatters: 'Georgia helped prove readiness, but the current mission is not another one-off Georgia patch. The system must prove Steve full-loop, then production auto-send.',
    nextAction: 'Do not build unless Steve explicitly reopens a Georgia-specific send. Active order is AGENT-FEEDBACK-STEVE-FULL-LOOP-TEST-001, then AGENT-FEEDBACK-PRODUCTION-AUTOSEND-ENABLE-001.',
  ...
  try {
    ...
    await client.query(
      ...
      [
        ...
        'Plan and execute only after Company Email policy is accepted. Target Steve Zahnd only. Use ClickUp Company Email as To, BCC Steve/Carson/Ryan/Georgia with Steve deduped, one-send limit, Gmail success before ClickUp Requested, and roles/hashes in tracked proof.',
        'Scoped on 2026-05-01. Hard rules: no Georgia test, no production-all auto-send, no other roster sends, no live reminder unless separately approved, and no raw emails, private token URLs, or feedback text in tracked docs/build log. The test flow must prove Gmail message/thread proof, ClickUp Requested proof, DB response proof, ClickUp Completed/Score/Feedback proof, internal notification proof, reminder stop proof, duplicate resend prevention, foundation:verify, clean commit, and push.',
      ]
    )
    ...
    await client.query(
      ...
      [
        ...
        'P1',
        16,
        'Steve mission to get Agent Feedback live after full-loop proof',
        'After the Steve full-loop test passes, enable production-all auto-send for eligible 30/60/90 onboarding feedback requests through the governed two-key approval path.',
        'The end state is a live daily Agent Roster scan that sends eligible onboarding feedback requests automatically, records proof, starts reminders when Requested remains incomplete, and notifies internal oversight after responses.',
        'Do not build until AGENT-FEEDBACK-STEVE-FULL-LOOP-TEST-001 is accepted. Start with dry-run production report, then enable production-all only after approval. Preserve Company Email only, BCC oversight, Gmail-before-Requested sequencing, duplicate protection, reminder cadence, response notification, and metadata-only broad proof.',
        'Scoped on 2026-05-01. Production behavior: daily scan of ClickUp Agent Roster, eligible 30/60/90 milestones send automatically, Company Email only, BCC Steve/Carson/Ryan/Georgia with dedupe, Gmail success before ClickUp Requested, duplicate ledger, reminder cadence active for Requested-but-not-completed, reminders stop when Completed/Skipped/Blocked, response notification active, and Runtime/Ops show sent/blocked/skipped/reminders/responses/repair states. No production-all enablement until separate approval.',
      ]
    )
    ...
    await client.query(
      ...
      [
        ...
        'Georgia helped prove readiness, but the current mission is not another one-off Georgia patch. The system must prove Steve full-loop, then production auto-send.',
        'Do not build unless Steve explicitly reopens a Georgia-specific send. Active order is AGENT-FEEDBACK-STEVE-FULL-LOOP-TEST-001, then AGENT-FEEDBACK-PRODUCTION-AUTOSEND-ENABLE-001.',
