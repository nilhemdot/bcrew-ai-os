...
const backlogSeed = [
  ...
  },
  {
    ...
    nextAction: 'Finish stable cursor/progress semantics and store all discovery occurrences for each normalized URL before scheduling or feeding platform-specific extractors.',
    statusNote: 'Target wrapper and raw-write guard are live. Latest controlled proof scanned 1060 archive/Drive records, found 179 media-link occurrences, and recorded a succeeded target run with 0 crawl failures. Remaining work is cursor/provenance-occurrence depth, not basic target control.',
  },
  {
    id: 'LOOM-001',
