...
const backlogSeed = [
  ...
  },
  {
    ...
    nextAction: 'Use the existing ClickUp working views to govern completion: Deal Data Entry `Full Deal List` (`8chw3b6-33791`) and Steve-visible Operations Agent Roster default view (`6-901113292355-1`). Require Deal # / Trade Number on transaction tasks, then backfill Owners row links, FUB shortcuts, and review evidence where source joins are proven. Review existing Agent Roster fields before adding any new roster truth fields.',
    statusNote: 'Readable and partially shaped now. Deal Data Entry has AIOS review fields for internal onboarding/deal-management surveys plus client NPS / Google-review workflow at the back of Full Deal List. Admin review joins ClickUp by Deal # first, then property/address fallback so missing Trade Numbers become explicit findings instead of false no-task claims. Agent Roster cleanup is paused: duplicate blank AIOS roster/source-truth/onboarding-NPS fields were created and should be removed through ClickUp field cleanup before any replacement fields are added.',
  },
  {
    id: 'SOURCE-005',
