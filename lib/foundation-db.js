...
const backlogSeed = [
  ...
  },
  {
    ...
    nextAction: 'Keep the live surfaces explicit: Agent Roster list `901113292355`, Agent Onboarding list `901113487352`, Culture space / folder `90117028331`, and Operations / Deals / Deal Data Entry list `901112153939`. Monitor roster contract fields, then separately define the ClickUp/FUB capture-rate model for post-close survey, NPS, Google-review, and sub-9 feedback tracking.',
    statusNote: 'Readable now. Roster/contract fields and Deal Data Entry tasks are proven readable. The open work is turning contract-link changes and post-close survey/review tasks into governed review inputs, not rediscovering whether ClickUp matters.',
  },
  {
    id: 'SOURCE-005',
