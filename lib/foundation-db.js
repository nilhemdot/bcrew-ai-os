...
const backlogSeed = [
  ...
  },
  {
    ...
    nextAction: 'Use the first Strategy Evidence Packet v1 as the strategy-prep proof, then define the review/approval workflow that promotes accepted issues into quarterly priorities, decisions, backlog items, and Action Router records.',
    statusNote: 'First proof generated on 2026-04-26: `strategy:evidence-packet` read 180 mined candidates, 25 direct Drive/video/email/meeting artifacts, 8 strategy docs, live backlog/decisions/runtime facts, and produced a persisted owner-level packet in Strategic Execution. Still open: approval/locking workflow and Strategy Hub workspace model.',
  },
  {
    id: 'GOV-003',
