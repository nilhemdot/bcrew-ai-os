  ...
  try {
    ...
    await client.query(
      ...
      [
        ...
        'P0',
        8,
        'Build governed synthesis over intelligence_synthesis_facts plus hybrid evidence results; persist synthesized items with fact/evidence links before any Strategy Hub surface resumes.',
        'Next Foundation spine gate after SYNTHESIS-FACTS-001. Use persisted source facts and hybrid evidence; do not restart Strategy Hub UI/advisor work.',
      ]
    )
