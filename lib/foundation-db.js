...
const backlogSeed = [
  ...
  },
  {
    ...
    statusNote: 'V1 shipped and proved: 27 Drive artifacts / 451,581 chars archived, including John KT Binder MAR 2026.pdf, Team Prestrat Template, Q2 pre-strat PDFs, Carson/Steve notes, and the Q1 vision/core-values doc. Remaining skips are explicit and file-type based.',
  },
  {
  ...
  try {
    ...
    await client.query(`
      ...
      CREATE TABLE IF NOT EXISTS shared_communication_artifacts (
        ...
        artifact_type TEXT NOT NULL
          CHECK (artifact_type IN ('meeting_note', 'meeting_transcript', 'email_thread', 'calendar_event', 'missive_thread', 'slack_thread', 'drive_document', 'drive_pdf', 'drive_text')),
    ...
    await client.query(
      ...
      [
        ...
        'First runtime slice is live: registered jobs, DB-backed run history, CLI runner, source-crawl target ledger, dashboard visibility, and Drive Docs/PDF/text content extraction. Missing pieces are retrieval spine, atom schema, rich multimodal extractors, attachment extraction, and governed action routing.',
      ]
    )
