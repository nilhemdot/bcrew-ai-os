...
const backlogSeed = [
  ...
  },
  {
    ...
    nextAction: 'Hold Strategy Hub review/promote UI, advisor chat, recommended priorities, and Strategy Package cleanup until the Foundation spine is real: INTEL-ATOM-001, retrieval, synthesis facts, governed synthesis, and Action Router. When Strategy resumes, rebuild from deterministic source-to-gap snapshots plus source-backed evidence, not old packet recommendations.',
    statusNote: 'Strategy Advisor v1 and the packet workflow are now historical/debug evidence only. The active Strategic Execution page is a Strategy Hub v2 safety stub, the advisor endpoint returns strategy_hub_v2_in_progress, and old active 90-day priority generation is disabled. Live goal/operating truth guardrails remain available for future v2 work, but Strategy Hub is no longer the next build surface.',
  },
  {
    id: 'STRATEGY-007',
  ...
  },
  {
    ...
    statusNote: 'Promoted from audit. This is the next Foundation spine step after INTEL-ATOM-001.',
  },
  {
    id: 'RETRIEVAL-002',
