...
const backlogSeed = [
  ...
  },
  {
    ...
    priority: 'P1',
    rank: 15,
    source: '2026-04-26 and 2026-04-27 builder/reviewer conversation review',
    summary: 'Review the builder/reviewer conversations from the intensive Foundation spine and Strategy Hub repair cycle, then promote durable lessons into system strategy, backlog cards, or verifier checks.',
    whyItMatters: 'The system learned important lessons: function beats form, verifiers can become the accidental spec, loose atom spam must be caught by output-quality checks, build closeout belongs in Foundation, and AIOS must support live meeting discussion. Those lessons should not live only in chat memory.',
    nextAction: 'Extract proposed patches for `docs/system-strategy.md` or the current strategy/rebuild docs plus any new backlog cards. Topics to mine: function-vs-form testing, loose atom spam, verifier-becomes-spec drift, build closeout discipline, meeting-participant vision, plain-English titles, AIOS as Q2 priority, and modular hub architecture for Marketing/Ops.',
    statusNote: 'Scoped from Steve review on 2026-04-27. Do not create another loose audit doc unless the output is explicitly promoted into repo truth or backlog.',
  },
  {
    ...
    priority: 'P0',
    rank: 16,
    source: 'Steve live review of Strategy Hub synthesis titles',
    summary: 'Ensure Strategy Hub items can be read aloud in a leadership or ownership meeting and immediately understood: plain-English title, why it matters, owner, urgency/time horizon, source proof, and next discussion/action.',
    whyItMatters: 'The product vision is not just managing cards. AIOS should sit open in meetings while the team talks through surfaced issues and moves work down the field. If titles read like internal topic tokens, the system fails even when the backend classification is technically correct.',
    nextAction: 'Before STRATEGY-QUARTER-001 closes, add meeting-readable title and item framing requirements to the Hub and synthesis preview: no jargon such as source-map gap, no raw topic-ref tokens, clear owner/urgency/why-it-matters, and a way for Steve to inspect latest synthesized classifications without the CLI.',
    statusNote: 'Created on 2026-04-27 after Steve accepted the underlying lead-source issue as strategic but did not recognize the phrase "source-map gap." The first title fix now says "Clarify where leads come from across Benson Crew / Steve Zahnd / MarketMasters."',
  },
  {
    ...
    whyItMatters: 'Strategy Hub should not only observe source facts. It needs the current quarter operating intent so AIOS can help Steve and the ownership team review issues weekly, surface suggestions, route decisions, and arrive at the next quarterly strategy cycle with the system already carrying the work.',
    nextAction: 'Build v1 as PostgreSQL-backed canonical records with source ID `SRC-STRATEGY-QUARTER-001`; write path through Strategy Hub owner/admin forms, not CLI-only or direct sheet edits; synthesis integration through new strategy-quarter fact types in the source fact ledger, aligned with goal-truth-style source facts. Use existing Drive/notes as import evidence, not the canonical write surface.',
    statusNote: 'Scoped on 2026-04-27. This is not rushed for the just-finished strategy session; it is the weekly ownership operating layer and the input system for the next strategy cycle. Data store, write path, and synthesis integration are pinned before build starts.',
  },
  {
    id: 'STRATEGY-007',
