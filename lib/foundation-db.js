  ...
  try {
    ...
    await client.query(
      ...
      [
        ...
        'Closed under agent-feedback-production-autosend-enable-v1. Stop for Steve review. Next work is Foundation + Strategy only.',
