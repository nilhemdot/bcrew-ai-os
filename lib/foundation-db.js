...
const backlogSeed = [
  ...
  },
  {
    ...
    nextAction: 'Done for v1. Keep raw foundation:verify wrapped in bounded transient retry and keep deterministic fixture proof for transient deadlock retry versus permanent fail-closed behavior.',
    statusNote: 'Closed on 2026-04-29 under foundation-control-layer-v1. V1 adds lib/foundation-gate-reliability.js, scripts/process-gate-reliability-check.mjs, npm run process:gate-reliability-check, deterministic injected transient/permanent proof, and a raw foundation:verify retry wrapper for transient gate errors. It does not induce real DB deadlocks or hide permanent verifier failures. Proof commands: npm run process:gate-reliability-check and npm run foundation:verify.',
  },
  {
