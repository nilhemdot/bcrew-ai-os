...
const backlogSeed = [
  ...
  },
  {
    ...
    nextAction: 'Use the AIOS ClickUp views to govern completion: `AIOS Deal Workflow` (`8chw3b6-47511`), `AIOS Review Follow-Up` (`8chw3b6-47531`), and `AIOS Agent Roster Source Truth` (`8chw3b6-47551`). Require Deal # / Trade Number on transaction tasks, then backfill Owners row links, FUB shortcuts, and review evidence where source joins are proven.',
    statusNote: 'Readable and partially shaped now. Deal Data Entry has AIOS review fields for internal onboarding/deal-management surveys plus client NPS / Google-review workflow, and Agent Roster has the missing membership/start/end/roster-status fields. No old ClickUp fields were deleted; finance/math clutter should be hidden from active views first and deleted only after backup/approval.',
  },
  {
    id: 'SOURCE-005',
  ...
  },
  {
    ...
    nextAction: 'Keep the read boundary aligned as DATA-006/DATA-008 deepen Admin review and missing-link backfill. Do not add FUB mutations until an approval-gated apply lane exists.',
  ...
  },
  {
    ...
    nextAction: 'Use the locked rule model in DATA-006/DATA-007/DATA-008 cleanup. Keep unresolved source rows queued instead of guessing, and keep source-field fixes human-owned until the apply lane is approved.',
  ...
  },
  {
    ...
    nextAction: 'Use the executable review lane to drive DATA-007/DATA-008/DATA-009 cleanup. Keep source-field fixes human-owned until an approval-gated apply lane exists.',
    statusNote: 'Closed on 2026-04-25 for v1 Admin deal-review enforcement. The Admin runner writes CC/CD/CE and now checks split math, governed source classification, company/agent expectation, FUB joins/source/stage/ISA evidence, pre-2026-04-01 Freedom follow-through, and the post-2026-04-01 ClickUp/FUB follow-through boundary without falsely failing rows for missing old Freedom data. Conditional review has the matching S:U review lane but still needs row identity backfill through DATA-008-style cleanup.',
  },
  {
    id: 'DATA-007',
  ...
  },
  {
    ...
    nextAction: 'Keep Gmail / Missive / Slack / meeting archives stable, deepen candidate promotion paths, add read-side subject-person redaction, and close the synthesis functions on top: cross-artifact linking, resolution detection, cross-source dedup, staleness scoring, and actionability ranking.',
  ...
  },
  {
    ...
    nextAction: 'Retire the dead per-row Freedom bonus assumptions, then design one governed Q2 bonus model for quality calls, improvement projects, data accuracy, eligible-client survey capture, NPS, Google reviews, and sub-9 feedback. ClickUp Deal Data Entry and FUB transcripts are candidate sources; Owners/FUB/QuickBooks own data accuracy.',
    statusNote: 'Q2 2026 policy PDF is now read. Do not encode the old Freedom per-row NPS/Google-review bonus as live truth for post-2026-04-01 deals.',
  },
  {
    id: 'DATA-022',
