...
const backlogSeed = [
  ...
  },
  {
    ...
    nextAction: 'Use the existing ClickUp working views to govern completion: Deal Data Entry `Full Deal List` (`8chw3b6-33791`) and Agent Roster `Active Roster` (`8chw3b6-46591`). Require Deal # / Trade Number on transaction tasks, then backfill Owners row links, FUB shortcuts, and review evidence where source joins are proven.',
