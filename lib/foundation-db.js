  ...
  snapshot.push(
    {
      ...
      detail: 'Prorated team target-to-date for the current Toronto calendar year.',
      asOf: getTodayTorontoIso(),
      sortOrder: 11,
    },
    {
  ...
  snapshot.push(
    {
      ...
      detail: 'Prorated community target-to-date for the current Toronto calendar year.',
