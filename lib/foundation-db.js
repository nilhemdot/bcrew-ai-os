...
const backlogSeed = [
  ...
  },
  {
    ...
    statusNote: 'Doctrine is locked: Foundation + router + adapters. Steve can buy multiple seats/accounts under BCrew emails such as steve.zahnd, ai, crewbert, and harlan; treat those as named compliant capacity lanes, not blind account rotation. Current state: local Codex CLI / OpenClaw is signed in as steve.zahnd@bensoncrew.ca for the Strategy/System subscription route. Strategy Advisor Fast is compact live-meeting mode; Deep requests xhigh-style synthesis on the smartest available subscription route. OpenClaw and Claude Code are plugs, not the OS; subscriptions are internal capacity, not the product backend.',
  },
  {
    id: 'LLM-ROUTER-001',
  ...
  },
  {
    ...
    nextAction: 'Build the first surface-freshness sweep: map each Foundation page to its backing source/API/doc/backlog owner, add stale-surface checks to `foundation:verify`, and require a sweep checklist after work that changes source contracts, connectors, job schedules, docs, backlog, Systems, Data Sources, System Inventory, or hub links.',
    statusNote: 'Created after the connector/status correction showed the dashboard could serve stale-looking truth until the source registry, UI copy, live API, verifier, and dashboard process were swept together. This is not UI polish; it is Foundation trust hygiene.',
  },
  {
    id: 'MEMORY-001',
  ...
  },
  {
    ...
    nextAction: 'Add review/promote controls on top of Strategy Advisor v1: let Steve accept/reject/needs-evidence packet items, then promote accepted work into quarterly priorities, decisions, backlog items, and Action Router records. Add source-specific question views like who-said-what and top strengths/themes by pre-strat participant. Keep goal/pace claims source-first through STRATEGY-010 and coordinate UI cleanup through STRATEGY-009.',
    statusNote: 'Strategy Advisor v1 is wired in Strategic Execution with a routed LLM question surface, full-screen chat workspace, Fast/Deep modes, direct artifact search for who-said-what questions, review board, session-saved thread, and floating chat launcher. Fast mode now uses a compact live-meeting context and shorter response budget; Deep mode requests xhigh-style synthesis on the smartest available subscription route. Pre-strat read coverage is explicit through STRATEGY-008: 8/9 expected Q2 notes read, Blake missing, Scott visual review captured, fillable PDF form fields extracted. STRATEGY-010 adds a live goal-truth guardrail so $2B, 10,000 agents, BHAG, recruiting pace, and active-capacity answers use live source rows before packet summaries. Latest refreshed packet read 220 mined candidates, 58 direct artifacts, 8 strategy docs, and 40 Drive artifacts, but stale packet wording must not outrank currentGoalTruth.',
  },
  {
    id: 'STRATEGY-007',
  ...
  },
  {
    ...
    nextAction: 'Done for v1. Keep using the coverage panel before the strategy session; if Blake or any late note appears in Drive, rerun Drive content extraction and confirm the participant row turns from Missing to Read.',
    statusNote: 'Closed on 2026-04-26. Strategic Execution now has /api/strategic-execution/prework-coverage, Advisor context includes preworkReadCoverage, and the UI shows Pre-Strat Read Coverage. Live checkpoint: 8/9 expected rows read, 10 current Q2 artifacts indexed, Blake still explicit as missing, Scott covered through manual visual review, and Ryan/Carson/Georgia/Ahsan through fillable PDF form fields.',
  },
  {
    id: 'STRATEGY-009',
  ...
  },
  {
    ...
    statusNote: 'Foundation ingests and approves. Hub Scopers read, deepen, and scope. Later specialist agents act. The old-system rule that Scopers must query atoms directly is now a design gate for REPORT-MINING-001 and INTEL-ATOM-001; the full Scoper contract remains required before hub acting agents.',
  },
  {
    id: 'AGENT-005',
  ...
  },
  {
    ...
    nextAction: 'Build the continuous version of the packet substrate: link synthesized items to candidates/artifacts/source facts, detect resolution/supersession, score staleness, rank actionability, and keep generating ownership packets without rediscovering resolved issues.',
    statusNote: 'First persisted Strategy Evidence Packet v1 exists and is visible in Strategic Execution. It generated strategic issues, decision candidates, and 90-day priority recommendations from mined candidates plus direct Drive/video/email/meeting artifacts and source facts. Still open: continuous state, resolution awareness, retrieval, and Action Router handoff.',
  },
  {
  ...
  },
  {
    ...
    statusNote: 'First runtime slice is live: registered jobs, DB-backed run history, CLI runner, source-crawl target ledger, dashboard visibility, Drive Docs/PDF/text content extraction, Gmail PDF/text attachment extraction, and YouTube subtitle transcript extraction. Missing pieces are retrieval spine, atom schema, rich multimodal extractors, Missive/richer attachment extraction, and governed action routing.',
  },
  {
    id: 'DRIVE-CORPUS-001',
  ...
  },
  {
    ...
    nextAction: 'Keep daily Drive inventory/content extraction running. Continue link-following for strategy docs, add Sheets/Slides/Office/shortcut target workers, and move rich handwriting, screenshots, and Drive/video media into the governed multimodal lane.',
    statusNote: 'Read-only inventory and content extraction slices are live. Drive Docs/PDF/text/markdown extraction, linked-doc inventory, and rough OCR fallback have proven against the strategy folder, John agenda/binder, Q2 pre-strat PDFs, Scott handwritten scan, and Steve draft. The umbrella still depends on file-type workers and MEETING-VIDEO-001/MULTIMODAL-EXTRACTOR-001 for rich media and high-confidence handwriting.',
  },
  {
    ...
    nextAction: 'Monitor the scheduled drive-content-extract-bite target, keep strategy folders prioritized, continue agenda/link inventory, finish John-linked access after approvals arrive, and add next file-type extractors: Sheets, Slides, Office conversion, shortcut target resolution, vision-grade handwriting/screenshots, and media routing into MULTIMODAL-EXTRACTOR-001.',
    statusNote: 'V1 shipped and proved: 40 Drive artifacts / 713,744 chars archived, including John KT Binder MAR 2026.pdf, John Q1 agenda plus accessible linked docs, Team Prestrat Template, Q2 pre-strat PDFs, PDF form fields from fillable pre-strat docs, Carson/Steve notes, Steve Q2 draft markdown, Scott handwritten scan via manual visual review, and the Q1 vision/core-values doc. John-linked access gaps are recorded; Steve manually requested the remaining access. The Strategy Folder is documented as quarterly evidence intake; remaining skips are explicit and file-type/access based.',
  },
  {
    ...
    statusNote: 'First slice shipped and proved: controlled Gmail run inspected 5 attachments, extracted 2 PDF artifacts / 1,949 chars, skipped 3 images with `image_ocr_requires_multimodal_lane`, and recorded 0 crawl failures. After worker restart, `email-attachment-extract-bite` also succeeded and totals reached 6 Gmail attachment artifacts / 21,494 chars with 4 skipped image attachments. Current daily email sync should still not be treated as full email understanding until Missive and multimodal attachment handling are proven.',
  },
  {
  ...
  },
  {
    ...
    nextAction: 'Promote the Strategy Evidence Packet v1 source-fact bundle into a reusable synthesis input contract, then add richer KPI/finance exception probes and source-health scoring before Strategy Hub depends on it continuously.',
    statusNote: 'First implementation landed in `strategy:evidence-packet`: source facts now include strategy docs, BHAG/Owners facts, critical backlog, decisions, open questions, recent changes, latest job runs, crawl targets, direct artifacts, and archive/candidate summaries. Still open: richer metric exception probes and reusable contract extraction.',
  },
  {
    id: 'INTEL-JOBS-001',
  ...
  },
  {
    ...
    nextAction: 'After REPORT-MINING-001 is accepted, design the v1 atom/candidate/report contract: source_id, artifact_id, intelligence_job_run/job_id, modality, timestamp/page/row anchor, evidence excerpt, derived claim, source confidence, sensitivity/access boundary, content-use class, value_route, generated report/brief link, hit/frequency model, direct scoper query fields, suggested owner/action, expires/supersedes fields, and accept/reject feedback state.',
    statusNote: 'Blocked until REPORT-MINING-001 produces the old-system intelligence salvage spec. Do not implement atom tables from a raw-extraction-only model.',
  },
  {
    id: 'RETRIEVAL-001',
  ...
  },
  {
    ...
    statusNote: 'First small worker proof is live through DataForSEO YouTube subtitles, the shared video queue, rough OCR fallback on a handwritten strategy scan, and a manual visual review of Scott pre-strat. Still open: automated vision-grade handwriting, rich visual review, no-subtitle videos, Loom, Skool, Zoom/meeting recordings, Drive videos, slides, demos, screenshots/keyframes, audio/visual scoring, and downstream atoms.',
  },
  {
  ...
  },
  {
    ...
    statusNote: 'First YouTube subtitle lane is live from manifest URLs: 13 video_transcript artifacts / 261,853 chars after worker and manual Mycro follow-up. Discovery, creator watchlists, comments, channel cadence, and Gemini/video-vision understanding are still open. Do not start with 200 videos.',
  },
  {
  ...
  },
  {
    ...
    nextAction: 'Keep the index generator authoritative, require a promoted-to target for evidence before build work depends on it, and keep All Docs framed as storage inventory rather than active doctrine.',
    statusNote: 'First slice done on 2026-04-25: indexes now include generated timestamps, promoted-to column, and no free-floating active-reference status. 2026-04-26 updates added verifier guards for System Strategy / Rebuild Plan alignment and clarified All Docs as file-level inventory, not the active truth queue.',
  },
  {
    id: 'DB-SEED-001',
  ...
  },
  {
    ...
    nextAction: 'Create `docs/specs/2026-04-27-intelligence-spine-old-system-salvage.md`: inventory the highest-signal old Director, Marketing Director, Scoper, atom extractor, atom CLI, and content_atoms patterns; extract durable doctrine and repeated output shapes; define generated report/brief artifacts; specify that Scopers query atoms directly; and list the required changes to INTEL-ATOM-001 before implementation.',
    statusNote: 'P0 gate after INTEL-JOBS-001 and before INTEL-ATOM-001. Blocks atom schema implementation until the old Director/Scoper/Gold Library/report-shape salvage spec is accepted.',
  },
  {
    id: 'SOURCE-021',
  ...
  try {
    ...
    await client.query(`
      ...
      CREATE TABLE IF NOT EXISTS shared_communication_artifacts (
        ...
        artifact_type TEXT NOT NULL
          CHECK (artifact_type IN ('meeting_note', 'meeting_transcript', 'email_thread', 'calendar_event', 'missive_thread', 'slack_thread', 'drive_document', 'drive_pdf', 'drive_text', 'gmail_attachment', 'video_transcript')),
    ...
    await client.query(
      ...
      [
        ...
        'First runtime slice is live: registered jobs, DB-backed run history, CLI runner, source-crawl target ledger, dashboard visibility, Drive Docs/PDF/text content extraction, Gmail PDF/text attachment extraction, and YouTube subtitle transcript extraction. Missing pieces are retrieval spine, atom schema, rich multimodal extractors, Missive/richer attachment extraction, and governed action routing.',
      ]
    )
...
export async function getStrategyOperatingTruthSnapshot() {
  const [
    ...
    getSheetValues('service-account', OWNERS_SHEET_ID, "'Listings and Conditional Deals'!A1:B8"),
  ...
  const sourceCards = [
    ...
    cardFromContract(
      ...
      [
        ...
        sourceFact('Expected Team $ This Month', formatCompactCurrency(parseNumber(findSheetMetric(conditionalRows, 'Expected team $ this month'))), 'Listings and Conditional Deals forecast metric.', 'SRC-OWNERS-001'),
      ],
