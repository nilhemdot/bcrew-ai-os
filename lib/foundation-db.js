...
const backlogSeed = [
  ...
  },
  {
    ...
    summary: 'Make the Systems page easier to scan by grouping systems by business/service area while preserving source-backed system detail.',
    whyItMatters: 'Foundation Systems currently explains operating bundles, but Steve needs to read it by how the business works. Grouping by service area makes it clear which systems serve Foundation, Strategy, Sales, Recruiting, Marketing, onboarding, deals, finance, operations, extraction, people, and review/accountability.',
    nextAction: 'Plan and build Systems grouping only after this capture is reviewed. Required groups: Foundation / Control Plane; Strategy / Leadership; Sales; Recruiting; Marketing - Clients; Marketing - Agents; Agent Onboarding; Client Onboarding; Closing / Deals; Finance; Operations; Source Intelligence / Extraction; People / Retention; Review Queues / Accountability.',
    statusNote: 'Scoped on 2026-04-30 by FOUNDATION-FOLLOWUP-CARD-CAPTURE-001. Hard rules: Sales and Recruiting must stay separate. No combined Sales/Recruiting bucket. Systems touching both must have primary + secondary service area. This future card is for grouping the Systems page only; no Strategy, Scoper, Agent Factory, corpus, source expansion, research cleanup, or unrelated feature lane is approved.',
  },
  {
    ...
    rank: 9,
    source: 'Post SOURCE-LIFECYCLE-EXPANSION-001 review follow-up',
    summary: 'Make Agent Onboarding Feedback visible as an actual system with trigger, source, queue, form, writeback, statuses, blockers, proof surfaces, and privacy boundaries.',
  ...
  },
  {
    ...
    rank: 10,
    source: 'Post SOURCE-LIFECYCLE-EXPANSION-001 review follow-up',
    summary: 'Build the production 30/60/90 onboarding feedback send path only after the Systems grouping and Agent Onboarding Feedback system visibility slices are reviewed.',
    ...
    nextAction: 'Plan this send-path build after FOUNDATION-SYSTEMS-SERVICE-GROUPING-001 and AGENT-ONBOARDING-FEEDBACK-SYSTEM-001. Dry-run first. No real send without Steve\'s route-specific approval. Georgia test target. To: Georgia\'s personal email from ClickUp unless Steve gives a different email. CC: Steve, Carson, Ryan, Georgia if desired.',
    statusNote: 'Scoped on 2026-04-30 by FOUNDATION-FOLLOWUP-CARD-CAPTURE-001. Required send boundaries: Capture Gmail message/thread ID. Mark Requested in ClickUp only after Gmail send succeeds. Duplicate send protection. No send if Personal Email missing. No send if milestone window expired. Submitted feedback still writes Completed, score, and feedback text back to the correct ClickUp Onboarding NPS 30/60/90 Status, Score, and Feedback fields. Feedback response is stored in the agent_onboarding_feedback_responses table with task ID, agent name, milestone day, token hash, score, feedback, and submitted timestamp. Feedback content is not broadly exposed outside approved owner/review surfaces. This card is not approved to send real email until Steve gives route-specific approval.',
  },
  {
