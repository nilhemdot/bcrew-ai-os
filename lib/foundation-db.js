...
const backlogSeed = [
  ...
  },
  {
    ...
    statusNote: 'Shared archive is materially real across Gmail, Missive, Slack, meeting notes, meeting transcripts, Drive Docs/PDF/text, and Gmail PDF/text attachments. It is not complete source understanding until Missive attachments, richer attachment file types, OCR/media, and linked meeting videos are handled. See EMAIL-ATTACHMENTS-001, DRIVE-CONTENT-001, MEETING-VIDEO-001, and MULTIMODAL-EXTRACTOR-001.',
  },
  {
    id: 'SOURCE-020',
  ...
  },
  {
    ...
    statusNote: 'First runtime slice is live: registered jobs, DB-backed run history, CLI runner, source-crawl target ledger, dashboard visibility, Drive Docs/PDF/text content extraction, and Gmail PDF/text attachment extraction. Missing pieces are retrieval spine, atom schema, rich multimodal extractors, Missive/richer attachment extraction, and governed action routing.',
  },
  {
    id: 'DRIVE-CORPUS-001',
    ...
    await client.query(`
      ...
      CREATE TABLE IF NOT EXISTS shared_communication_artifacts (
        ...
        artifact_type TEXT NOT NULL
          CHECK (artifact_type IN ('meeting_note', 'meeting_transcript', 'email_thread', 'calendar_event', 'missive_thread', 'slack_thread', 'drive_document', 'drive_pdf', 'drive_text', 'gmail_attachment')),
