...
const backlogSeed = [
  ...
  },
  {
    ...
    nextAction: 'RETRIEVAL-001 remains closed. Continue the Foundation spine through ACTION-ROUTER-001 on top of governed synthesis; keep Strategy Hub review/promote UI, advisor chat, and recommendations blocked until action routing is live.',
  ...
  },
  {
    ...
    nextAction: 'RETRIEVAL-002 remains closed. Continue the Foundation spine through ACTION-ROUTER-001 on top of hybrid evidence, source-backed facts, and governed synthesis. Keep Strategy Hub UI/advisor/recommendations blocked.',
  ...
  try {
    ...
    await client.query(
      ...
      [
        ...
        'P0',
        8,
        'Build ACTION-ROUTER-001 so synthesized items route into governed decisions, backlog, open questions, contradictions, ignore/snooze records, or owner-bound actions. Keep Strategy Hub UI/advisor/recommendations blocked until Action Router is live.',
        'Done v1 on 2026-04-27. Governed synthesis persists owner-suggested synthesized items with source fact refs, hybrid evidence refs, evidence chunk refs, maxTier, structured attributes, and corpus-diversity proof.',
      ]
    )
