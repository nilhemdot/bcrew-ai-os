...
const backlogSeed = [
  ...
  },
  {
    ...
    nextAction: 'Do not build until AGENT-FEEDBACK-REAL-USER-SUBMIT-REPAIR-001 is accepted. Start with dry-run production report only after Steve’s real browser submission passes, then production-all only after separate approval.',
  ...
  try {
    ...
    await client.query(
      ...
      [
        ...
        'Do not build until AGENT-FEEDBACK-REAL-USER-SUBMIT-REPAIR-001 is accepted. Start with dry-run production report only after Steve’s real browser submission passes, then production-all only after separate approval.',
