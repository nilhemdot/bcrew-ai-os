...
const backlogSeed = [
  ...
  },
  {
    ...
    statusNote: 'Promoted to the next Foundation build after the 2026-04-28 hard checkpoint. Strategy Hub route-review proof plumbing advanced, but Steve did not accept the UI as meeting-ready; return to Foundation trust hygiene before more hub or Scoper expansion.',
  },
  {
  ...
  },
  {
    ...
    nextAction: 'Design the v2 build/change record shape, then decide whether to enrich the git-backed API or add DB-backed build records. The visible page must group work by system area and day, link commits to backlog cards and proof commands, show shipped/executing/accepted/blocked status, and make "what should Steve review next" obvious. Add verifier coverage so major build closeouts remain visible in Recent Builds.',
    statusNote: 'New P0 from the 2026-04-28 hard checkpoint. `FOUNDATION-CHANGELOG-001` closed the v1 done-lane guard, but Steve still could not tell what was built or where it lived from the current page. Build this before more high-level Strategy UI polish.',
  },
  {
    id: 'MEMORY-001',
  ...
  },
  {
    ...
    statusNote: 'V1 proof plumbing shipped in commit `784fbf2`: human-readable proof, action guide/tooltips, owner picker, snooze durations, reject confirmation, and Applied / Done grouping. Steve explicitly did not accept the UI quality as meeting-ready on 2026-04-28. Keep this scoped/parked until Foundation trust and build-visibility work catch up.',
  },
  {
  ...
  },
  {
    ...
    statusNote: 'Source crawl targets/items now support scheduled current-day sync, Drive inventory, video-link inventory, and daily shared-comms extraction missions. 2026-04-28 hard checkpoint found stale `slack-current-day` run `crawl-slack-current-day-20260427145904292-3f93bebd` still marked running from Apr 27; carry stale crawl-run detection/reaping into the next Foundation sweep/runtime hardening pass. Remaining work is operator-facing coverage truth, retry semantics, and source-specific backlog completion state.',
  },
  {
