  ...
  try {
    ...
    await client.query(
      ...
      [
        ...
        'P0',
        8,
        'Keep governed synthesis v1 operating as the source-backed item layer feeding Action Router and Strategy Hub v2. Next work is Strategy Hub v2 source-to-gap plus route review/promote on top of facts, synthesized items, and action routes; no advisor chat or recommendation surface.',
