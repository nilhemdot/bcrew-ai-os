...
const backlogSeed = [
  ...
  },
  {
    ...
    nextAction: 'Add review/promote controls on top of Strategy Advisor v1: let Steve accept/reject/needs-evidence packet items, then promote accepted work into quarterly priorities, decisions, backlog items, and Action Router records.',
    statusNote: 'First proof generated on 2026-04-26: `strategy:evidence-packet` read 180 mined candidates, 25 direct Drive/video/email/meeting artifacts, 8 strategy docs, live backlog/decisions/runtime facts, and produced a persisted owner-level packet in Strategic Execution. Strategy Advisor v1 is now wired in Strategic Execution with a routed LLM question surface and a Review Board that maps packet items into Attract / Grow / Retain / Finance / Foundation lenses, AI-suggested moves, and proof gaps. An AIOS draft of Steve’s Q2 pre-strat was created in the Q2 Drive folder for review.',
  },
  {
    id: 'GOV-003',
