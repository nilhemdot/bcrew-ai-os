...
const backlogSeed = [
  ...
  },
  {
    ...
    statusNote: 'Strategy Advisor v1 is wired in Strategic Execution with a routed LLM question surface, review board, and floating chat launcher. Latest refreshed packet on 2026-04-26 read 220 mined candidates, 58 direct artifacts, 8 strategy docs, and 35 Drive artifacts now include John Q1 agenda/linked docs, Scott OCR/manual visual review, Carson/Scott Q2 prework, and Steve Q2 draft. An improved first-person AIOS draft of Steve’s Q2 pre-strat is in the Q2 Drive folder and archived.',
  },
  {
    id: 'STRATEGY-007',
    ...
    nextAction: 'Add a full-screen Strategy Advisor page/panel in Strategic Execution, preserve the floating launcher as quick access, add fast/deep mode controls, show route/model/latency, and wire saved question/answer context to the strategy evidence packet without hiding missing evidence.',
    statusNote: 'New live-use card. Current advisor is source-backed but can feel slow because it builds a large context and calls the routed subscription model. UX and capacity lanes need to make the tradeoff visible.',
  },
  {
    id: 'GOV-003',
  ...
  },
  {
    ...
    statusNote: 'V1 shipped and proved: 35 Drive artifacts / 679,888 chars archived, including John KT Binder MAR 2026.pdf, John Q1 agenda plus accessible linked docs, Team Prestrat Template, Q2 pre-strat PDFs, Carson/Steve notes, Steve Q2 draft markdown, Scott handwritten scan via rough OCR plus manual visual review, and the Q1 vision/core-values doc. John-linked access gaps are recorded; Steve manually requested the remaining access. The Strategy Folder is documented as quarterly evidence intake; remaining skips are explicit and file-type/access based.',
  },
  {
