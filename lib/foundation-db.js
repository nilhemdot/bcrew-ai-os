...
const backlogSeed = [
  ...
  {
    id: 'DEV-002',
    title: 'Define the research-to-scope pipeline and scoped-card standard',
    team: 'dev',
    lane: 'research',
    priority: 'P2',
    rank: 24,
    source: 'Old dev-team salvage',
    summary: 'Salvage the strongest upstream pattern from the old system: research agents find WHAT exists, intelligence decides WHY it matters, a scoper defines HOW to build it, and only then does work enter the ranked build queue as a fully scoped card.',
    whyItMatters: 'The old pipeline worked best when builders did not have to guess. The real value was not “lots of agents,” it was the quality gate that turned thin ideas into rich, buildable cards with context, constraints, risks, tests, and a clear definition of done before anyone started implementing.',
    nextAction: 'Define the v2 scoped-card standard for the new system: problem/context, why it matters, build shape, acceptance criteria, definition of done, risks, dependencies, verification/test plan, source links, and the handoff rule from research -> intelligence -> scope -> rank/build.',
    statusNote: 'Keep the good part of the old chain and drop the bloat. Even if you and Steve stay as the build team, this quality gate is still valuable because it prevents thin cards and half-scoped work from entering the queue.',
  },
  {
    id: 'UX-002',
