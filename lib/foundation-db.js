...
const backlogSeed = [
  ...
  },
  {
    ...
    nextAction: 'Define the quarterly planning pipeline: pre-work collection from the Drive Strategy Folder, evidence ingestion, synthesis prompts, strategic issue/contradiction/risk extraction, recommendation outputs, review checkpoints, and how final priorities get approved and locked.',
    statusNote: 'The Drive Strategy Folder is the quarterly evidence intake, not canonical strategy. The workflow should convert extracted Drive/meeting/KPI/FUB/finance evidence into strategy issues, options, decisions, and execution handoffs through Strategy Hub and the Action Router.',
  },
  {
    id: 'GOV-003',
