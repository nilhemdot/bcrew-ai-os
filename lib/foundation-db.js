...
const backlogSeed = [
  ...
  {
    id: 'AGENT-002',
    title: 'Build a live strategic operator for leadership meetings',
    team: 'dev',
    lane: 'research',
    priority: 'P1',
    rank: 29,
    source: 'Leadership meeting agent idea',
    summary: 'Create an agent that sits in leadership and strategy meetings, keeps the room on agenda, asks follow-up questions, captures decisions, turns them into structured work, and can push approved updates into connected systems like backlog, ClickUp, and operating trackers during the meeting.',
    whyItMatters: 'Steve should not have to both lead the business and act as the full-time strategy PM. A strong strategic operator could protect cadence, improve accountability, and close the gap between meeting decisions and real system updates.',
    nextAction: 'Define the MVP: live meeting presence, agenda enforcement, question prompts, decision extraction, owner/deadline tracking, approval rules for in-meeting system updates, and escalation rules when departments miss commitments.',
    statusNote: 'Start as a strategic operator for leadership and strategy cadences, not a transcript bot and not a fully autonomous meeting boss.',
  },
  {
    id: 'AGENT-003',
    ...
    summary: 'Let Harlan join a Google Meet or strategy session as a live strategic operator that can be activated by voice cues such as “Hey Harlan, kick us off” or “Hey Harlan, what are we missing?”',
    whyItMatters: 'If Harlan can be activated naturally in the room, it becomes much easier to use for kickoff, agenda discipline, question prompting, and approved in-meeting actions without turning the meeting into a manual operator workflow.',
    nextAction: 'Define the first live-meeting interaction model: wake phrase or push-to-talk trigger, Meet audio ingress, interruption rules, participant awareness, approval gates for live system changes, and when Harlan should speak versus stay silent.',
