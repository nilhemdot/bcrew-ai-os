...
const backlogSeed = [
  ...
  },
  {
    ...
    nextAction: 'Repair SYNTHESIS-ENGINE-001 before any further Strategy Hub work. Add failing output-quality gates, then rework synthesis so it links related signals, dedupes repeats, collapses atom/thread-level residue into strategy-grade themes, and prints a 5-row human-readable sample for Steve review.',
    statusNote: 'Reopened on 2026-04-27. Prior v1 was provenance-correct but wrong-grain: active items were effectively one atom/thread per item, with no theme/cluster metadata and duplicate operational routes leaking toward Strategy. Do not create SYNTHESIS-ENGINE-002; fix the original acceptance criteria here.',
  },
  {
  ...
  try {
    ...
    await client.query(
      ...
      [
        ...
        'P0',
        8,
        'Repair SYNTHESIS-ENGINE-001 before any further Strategy Hub work. Add failing output-quality gates, then rework synthesis so it links related signals, dedupes repeats, collapses atom/thread-level residue into strategy-grade themes, and prints a 5-row human-readable sample for Steve review.',
        'Reopened on 2026-04-27. Prior v1 was provenance-correct but wrong-grain: active items were effectively one atom/thread per item, with no theme/cluster metadata and duplicate operational routes leaking toward Strategy. Do not create SYNTHESIS-ENGINE-002; fix the original acceptance criteria here.',
      ]
    )
  ...
  const sourceCards = [
    ...
    cardFromContract(
      ...
      [
        ...
        sourceFact('Net To Team $ This Month', formatCompactCurrency(parseNumber(findSheetMetric(conditionalRows, 'Net to team $ this month'))), 'Listings and Conditional Deals forecast metric.', 'SRC-OWNERS-001'),
      ],
