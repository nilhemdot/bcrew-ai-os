  ...
  try {
    ...
    await client.query(
      ...
      [
        ...
        'P0',
        8,
        'Steve must review the 5-row synthesis sample before SYNTHESIS-ENGINE-001 can close again. Passing code gates now require clustered themes, duplicate collapse, Strategy/operational classification, and multi-evidence Strategy items.',
        'Repair build landed on 2026-04-27 and proof gates now check output quality, not just provenance form. Keep the card executing until Steve accepts the human-readable sample as strategy-grade.',
      ]
    )
