...
const backlogSeed = [
  ...
  },
  {
    ...
    nextAction: 'Use the shared video-content queue to prioritize meeting-linked Drive/Zoom/Loom/YouTube videos, classify access and rights, prefer existing transcripts where available, and add the next platform extractor proof behind explicit quota, ledger, and stop controls.',
    statusNote: 'First shared-video slice shipped: YouTube subtitle extraction from the video manifest produced 12 video_transcript artifacts / 235,537 chars after worker follow-up, with no-subtitle videos skipped into the future vision/transcription lane. Meeting-specific rich video review still needs Drive/Zoom/Loom/meeting-link prioritization under the same queue.',
  },
  {
    id: 'SKOOL-WORKER-001',
  ...
  },
  {
    ...
    nextAction: 'Extend the v1 video transcript lane into the GOD-mode contract: channel/video metadata, transcript acquisition, timestamp anchoring, screenshot/frame policy, visual/tool/workflow detection, model route, cost budget, rights/use boundary, quality score, skip reasons, and failure handling.',
    statusNote: 'First small worker proof is live through DataForSEO YouTube subtitles and the shared video queue. Still open: rich visual review, no-subtitle videos, Loom, Skool, Zoom/meeting recordings, Drive videos, slides, demos, screenshots, and downstream atoms.',
  },
  {
  ...
  },
  {
    ...
    statusNote: 'First YouTube subtitle lane is live from manifest URLs: 12 video_transcript artifacts / 235,537 chars after worker follow-up. Discovery, creator watchlists, comments, channel cadence, and Gemini video understanding are still open. Do not start with 200 videos.',
  },
  {
