...
const backlogSeed = [
  ...
  },
  {
    ...
    statusNote: 'Strategy Advisor v1 is wired in Strategic Execution with a routed LLM question surface, full-screen chat workspace, Fast/Deep modes, direct artifact search for who-said-what questions, review board, session-saved thread, and floating chat launcher. Latest refreshed packet on 2026-04-26 read 220 mined candidates, 58 direct artifacts, 8 strategy docs, and 40 Drive artifacts now include John Q1 agenda/linked docs, PDF form-field extraction for fillable pre-strat docs, Scott manual visual review, Carson/Scott/Ryan/Georgia/Ahsan/Nick prework, and Steve Q2 draft. An improved first-person AIOS draft of Steve’s Q2 pre-strat is in the Q2 Drive folder and archived.',
  },
  {
    id: 'STRATEGY-007',
