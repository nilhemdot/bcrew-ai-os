...
const backlogSeed = [
  ...
  },
  {
    ...
    nextAction: 'Define named capacity lanes for builder chat, system worker, Claude Code/coding, video/vision, and direct API fallback. Include owner email/account, provider, allowed workloads, weekly/monthly budget, pacing, fallback, and stop controls.',
    statusNote: 'Doctrine is locked: Foundation + router + adapters. Steve can buy multiple seats/accounts under BCrew emails such as steve.zahnd, ai, crewbert, and harlan; treat those as named compliant capacity lanes, not blind account rotation. OpenClaw and Claude Code are plugs, not the OS; subscriptions are internal capacity, not the product backend.',
  },
  {
    id: 'LLM-ROUTER-001',
  ...
  },
  {
    ...
    nextAction: 'Build the Strategy Review Board on top of the first evidence packet: classify each issue by Attract / Grow / Retain, show AI-suggested strategic moves, show what evidence is missing, let Steve accept/reject/needs-evidence items, then promote accepted items into quarterly priorities, decisions, backlog items, and Action Router records.',
    statusNote: 'First proof generated on 2026-04-26: `strategy:evidence-packet` read 180 mined candidates, 25 direct Drive/video/email/meeting artifacts, 8 strategy docs, live backlog/decisions/runtime facts, and produced a persisted owner-level packet in Strategic Execution. Steve clarified the next build must be an operator review workflow, not another packet: Attract/Grow/Retain lenses, AI suggestions, missing-data gaps, and promotion into live strategy records. An AIOS draft of Steve’s Q2 pre-strat was created in the Q2 Drive folder for review.',
  },
  {
    id: 'GOV-003',
  ...
  },
  {
    ...
    nextAction: 'Keep daily Drive inventory and content extraction running. Add file-type workers for Sheets, Slides, Office files, shortcut resolution, OCR/scanned PDFs, and Drive/video media before treating the full Drive corpus as understood.',
    statusNote: 'Read-only inventory and first content extraction slice are live. Drive Docs/PDF/text extraction has proven against the strategy folder and John binder. The umbrella still depends on follow-on file-type workers and MEETING-VIDEO-001 for media review.',
  },
  {
    ...
    summary: 'Drive access, inventory, and the first content extraction slice are live. Google Docs are exported as text; PDFs and plain-text Drive blobs are downloaded and parsed into normalized source artifacts. Unsupported Drive file types remain explicit follow-on lanes.',
    ...
    nextAction: 'Monitor the scheduled drive-content-extract-bite target, keep strategy folders prioritized, and add the next file-type extractors: Sheets, Slides, Office conversion, shortcut target resolution, OCR/scanned PDFs, and media routing into MULTIMODAL-EXTRACTOR-001.',
    statusNote: 'V1 shipped and proved: 27 Drive artifacts / 451,581 chars archived, including John KT Binder MAR 2026.pdf, Team Prestrat Template, Q2 pre-strat PDFs, Carson/Steve notes, and the Q1 vision/core-values doc. The Strategy Folder is now documented as quarterly evidence intake; remaining skips are explicit and file-type based.',
  },
  {
  ...
  },
  {
    ...
    nextAction: 'Start with one governed proof on an allowed/public or Steve-authorized page/app: load the page, navigate one small workflow, capture readable text, DOM outline, screenshots, links/media references, workflow observations, permissions/use class, cost/runtime metadata, and a source-backed summary. Then connect the worker to WEB-CRAWLER-001 boundaries and MULTIMODAL-EXTRACTOR-001 atoms.',
    statusNote: 'Not built. Browser Use exists in the coding session, but AIOS does not yet have a governed website/browser extraction worker. This is separate from YouTube subtitle extraction and must not be claimed done until artifacts/atoms land in Foundation.',
  },
  {
  ...
  },
  {
    ...
    nextAction: 'Extend the v1 video transcript lane into the GOD-mode contract: channel/video metadata, transcript/audio acquisition, timestamp anchoring, screenshot/keyframe policy, visual tool/workflow detection, screenshare/demo steps, model route, cost budget, rights/use boundary, quality score, skip reasons, and failure handling.',
    statusNote: 'First small worker proof is live through DataForSEO YouTube subtitles and the shared video queue, including Steve manual priority Mycro proof. Still open: rich visual review, no-subtitle videos, Loom, Skool, Zoom/meeting recordings, Drive videos, slides, demos, screenshots/keyframes, audio/visual scoring, and downstream atoms.',
  },
  {
...
export async function listDriveContentExtractionQueue({
  ...
  if (normalizedRetrySkippedReasonPrefixes.length) {
