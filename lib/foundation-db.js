...
const backlogSeed = [
  ...
  },
  {
    ...
    statusNote: 'Executing from 2026-04-28 Steve review. The first Strategy route title was fixed to "Clarify where leads come from across Benson Crew / Steve Zahnd / MarketMasters", but the UI still needs human-readable proof, action clarity, snooze durations, owner assignment, and Strategy-local applied visibility before it is meeting-ready.',
  },
  {
