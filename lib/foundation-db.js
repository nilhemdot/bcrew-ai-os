...
const backlogSeed = [
  ...
  },
  {
    ...
    nextAction: 'Plan a small doc-authority repair: update stale `docs/README.md` links, make retired plan-history docs clearly evidence/history instead of active truth, and repair old relative links inside retired docs without reopening the retired content.',
    statusNote: 'Scoped from the 2026-04-29 full-system re-audit. This is minor drift, not a Phase F blocker.',
  },
  {
    ...
    nextAction: 'Plan v2 wildcard/private-memory freshness coverage without copying private content, plus stronger tier-two review signals for `SOUL.md`, `docs/users/steve.md`, and agent/persona doctrine.',
    statusNote: 'Scoped from the 2026-04-29 full-system re-audit. This is minor drift, not a Phase F blocker.',
  },
  {
    ...
    nextAction: 'Plan a narrow v2 enforcement slice: decide whether this belongs in git hooks, npm scripts, or a ship wrapper, and preserve emergency-bypass reason logging.',
    statusNote: 'Scoped from the 2026-04-29 full-system re-audit. This is minor drift, not a Phase F blocker.',
  },
  {
