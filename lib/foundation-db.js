...
async function getLiveAgentEngineSourceSnapshot() {
  ...
  snapshot.push(
    ...
    buildEngineMetricRow('Current Requirement', 'Current Avg Production / Agent', `${formatCompactCurrency(avgProduction)} / month`, requirementEngineDetail, 10),
    buildEngineMetricRow('Current Requirement', 'Production Target / Agent', `${formatCompactCurrency(productionTarget)} / month`, requirementBhagDetail, 11, 'SRC-FREEDOM-BHAG-001'),
