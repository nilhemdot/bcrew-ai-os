...
const backlogSeed = [
  ...
  },
  {
    ...
    summary: 'Define the future agent-facing assistant experience inside the KPI / Sales Hub layer: each agent can ask about their KPI system, Home Value Hub, CRM/opportunity rules, and receive one source-backed coaching nugget per day through Telegram or the approved channel.',
    whyItMatters: 'The long-term value is not just replacing scattered SaaS. It is turning the rebuilt source layer into a useful agent coach that teaches the team how the business systems work, nudges better behavior daily, and eventually supports replacing expensive external CRM surfaces with an integrated AI OS.',
    nextAction: 'After KPI/FUB opportunity semantics, source privacy, and assistant identity boundaries are stable, write the first agent-coach contract: allowed sources, daily-nugget rules, opt-in/notification channel, role/tier visibility, forbidden/private content, KPI/Home Value Hub/FUB question types, and proof checks before any agent-facing bot goes live.',
    statusNote: 'This is the product destination for the KPI/FUB work, not a current build shortcut. It depends on SOURCE-021, SOURCE-017, SECURITY-002, UX-002, PEOPLE-003, and the future Sales Hub read layer.',
  },
  {
    id: 'RETAIN-001',
  ...
  },
  {
    ...
    summary: 'The live connection audit found ClickUp Deal Data Entry is readable and contains 1647 tasks, with 1210 tasks carrying a Deal #, but none of the 53 audited Owners deal groups that already have FUB links matched a ClickUp task by Deal #.',
    whyItMatters: 'ClickUp is supposed to own post-policy Ops follow-through, NPS, Google review, internal feedback, and FUB outreach evidence. If high-value FUB-linked deals do not join by Trade Number, AIOS can still inspect Owners/FUB/KPI truth but cannot reliably prove Ops follow-through without manual cleanup.',
    nextAction: 'Use Ops Hub findings and the connection audit to identify the current/deal-active tasks missing the correct Deal #, backfill the Trade Number where the task is real, and decide whether older closed tasks should be bulk repaired or left as historical evidence gaps.',
    statusNote: 'This is data-linkage cleanup, not an API-key or connector failure. ClickUp verification still passes; the problem is task-level Deal # coverage for the audited FUB-linked set.',
  },
  {
    id: 'DATA-022',
