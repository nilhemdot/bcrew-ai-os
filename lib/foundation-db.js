...
const backlogSeed = [
  ...
  },
  {
    ...
    nextAction: 'Plan and build the probe after this one-time hygiene pass: define stale thresholds by lane, cross-reference Recent Builds closeouts, surface findings in Runtime Health and/or Backlog, and make `foundation:verify` fail for critical hygiene drift.',
    statusNote: 'Scoped follow-up created by `BACKLOG-HYGIENE-PASS-001`. Not built yet. Must go through the scope -> plan -> review -> 9.8 gate before implementation.',
  },
  {
    ...
    summary: 'Review the concrete failures from the 2026-04-28 build loop: stale executing cards, chat-only priority changes, missing hygiene probe, trust slice shipped before the agreed hygiene pass, and no 9.8 plan gate before implementation.',
    ...
    nextAction: 'Produce a short failure-pattern list and map each failure to a hook, verifier, checklist, or backlog rule. Keep this focused on actionable process enforcement, not a broad retrospective.',
    statusNote: 'Scoped follow-up created by `BACKLOG-HYGIENE-PASS-001`. Not built yet. Must feed `PROCESS-HOOKS-001` before hook implementation.',
  },
  {
    ...
    summary: 'Create lightweight process hooks that enforce the dev loop before and after a ship: formal card, scored plan, verifier coverage, closeout draft, dashboard location, backlog lane update, plain-English Recent Builds entry, and proof command.',
    ...
    nextAction: 'After `DEV-PROCESS-AUDIT-001`, define the first enforceable hook set and decide which checks run pre-commit, post-ship, or inside `foundation:verify`. Keep the first slice narrow enough to avoid blocking legitimate emergency fixes.',
    statusNote: 'Scoped follow-up created by `BACKLOG-HYGIENE-PASS-001`. Recent Builds link/breadcrumb UX remains grouped under `FOUNDATION-SURFACE-UPDATES-001`; this card owns enforcement hooks, not the visible Recent Work redesign.',
  },
  {
    id: 'MEMORY-001',
