...
const backlogSeed = [
  ...
  },
  {
    ...
    statusNote: 'Doctrine is locked: Foundation + router + adapters. Steve can buy multiple seats/accounts under BCrew emails such as steve.zahnd, ai, crewbert, and harlan; treat those as named compliant capacity lanes, not blind account rotation. Current pain: builder chat and system Strategy Advisor should not silently burn the same weekly window. OpenClaw and Claude Code are plugs, not the OS; subscriptions are internal capacity, not the product backend.',
  },
  {
    id: 'LLM-ROUTER-001',
  ...
  },
  {
    ...
    statusNote: 'Closed on 2026-04-26. Strategic Execution now has a full-screen Strategy Advisor workspace, session-saved local thread, Fast/Deep mode controls, route/model/latency metadata, direct artifact search for who-said-what questions, and the original floating launcher preserved for quick access. Live proof: Ryan pre-strat question now answers from the filled PDF form fields instead of packet summary only.',
  },
  {
    id: 'STRATEGY-008',
