  ...
  try {
    ...
    await client.query(
      ...
      [
        'SOURCE-019',
        'scoped',
        'Keep Gmail / Missive / Slack / meeting archives stable, deepen candidate promotion paths, and add read-side subject-person redaction after the first cross-source lane stays usable for strategy prep and operating review.',
        'Shared archive is now materially real across Gmail, Missive, Slack, meeting notes, and meeting transcripts, with governed extraction live for all four and first apply paths for task -> backlog, decision -> decision, and blocker -> open question. Remaining work is cross-source normalization, broader apply types, and read-side privacy/query logic.',
      ]
    )
