...
const backlogSeed = [
  ...
  },
  {
    ...
    nextAction: 'Build the narrow v1 enforcement from `docs/audits/2026-04-28-dev-process-audit.md`: pre-commit card/plan/closeout checks, post-ship verifier/served-code/backlog-update checks, and a red-verifier stop rule. Keep emergency bypass explicit and do not build the visible Recent Work redesign here.',
    statusNote: 'Scoped follow-up created by `BACKLOG-HYGIENE-PASS-001` and sharpened by `DEV-PROCESS-AUDIT-001`. Acceptance for v1: require live backlog card reference, external 9.8+ plan approval, verifier plan, seven-field closeout draft, default `npm run foundation:verify` proof on localhost:3000, served dashboard commit equals repo HEAD, moved/split/updated touched cards, Recent Builds closeout with where-it-lives metadata, and stop-on-red-verifier behavior. Recent Builds link/breadcrumb UX remains grouped under `FOUNDATION-SURFACE-UPDATES-001`; this card owns enforcement hooks, not the visible Recent Work redesign.',
  },
  {
    id: 'MEMORY-001',
