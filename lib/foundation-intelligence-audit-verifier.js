...
export async function evaluateFoundationIntelligenceAuditVerifier(input = {}) {
  ...
  const foundationJobs = input.foundationJobs || foundationHub.foundationJobs || {}
...
export async function buildFoundationIntelligenceAuditVerifierDogfoodProof() {
  ...
  const rejected = [implementationMutation, buildIntelPaidAuth, gstackImport, auditAutoFix, nightlyWrite, nightlyScheduleDogfoodMissing, nightlyRunFreshnessMissing]
