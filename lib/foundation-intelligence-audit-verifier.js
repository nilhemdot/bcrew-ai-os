...
function syntheticBaseInput(overrides = {}) {
  ...
  return {
    ...
    foundationHub: { backlogItems, implementationIntelligence, buildIntelExtraction, karpathyKbPreflight, creatorWatchlistExpansion, foundationKnowledgeBaseCompilerDesign, knowledgeBaseQualityGate, gstackBuildIntel },
    backlogItems,
...
export async function buildFoundationIntelligenceAuditVerifierDogfoodProof() {
  ...
  const rejected = [implementationMutation, buildIntelPaidAuth, karpathyLiveExtraction, creatorWatchlistMissingUrl, knowledgeBaseDirectAgent, knowledgeBaseMissingCitation, gstackImport, auditAutoFix, nightlyWrite, nightlyScheduleDogfoodMissing, nightlyRunFreshnessMissing]
