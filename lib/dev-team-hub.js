...
} from './parallel-builder-lanes.js'
...
export function buildDevTeamHubV0Snapshot({
  ...
  const parallelBuilderLanesSnapshot = buildParallelBuilderLanesSnapshot()
  const parallelBuilderLanesEvaluation = evaluateParallelBuilderLanes(parallelBuilderLanesSnapshot)
  ...
  return {
    ...
    parallelBuilderLanes: {
      ...parallelBuilderLanesSnapshot,
      evaluation: parallelBuilderLanesEvaluation,
      sourceRoute: 'buildParallelBuilderLanesSnapshot() + evaluateParallelBuilderLanes()',
    },
    sourceRoutes: [
      ...
      { visibleValue: 'Parallel builder lanes control plane', route: 'buildParallelBuilderLanesSnapshot() + evaluateParallelBuilderLanes()', sourceId: 'AIOS-PARALLEL-BUILDER-LANES-001' },
    ],
