...
} from './dev-hub-auditor-promotion-boundary-preflight.js'
import {
...
export function buildDevTeamHubV0Snapshot({
  ...
  const auditorPromotionBoundaryPreflight = buildDevHubAuditorPromotionBoundaryPreflight({
    generatedAt,
    auditorFlowReadback,
    nextRepairQueue,
  })
  ...
  return {
    ...
    auditorPromotionBoundaryPreflight,
    intelligenceHygieneReadback,
    auditorFlowReadback,
    nextRepairQueue,
    actionRouteReadback,
