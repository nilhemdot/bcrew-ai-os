export const processGateOperationsCloseoutRecords = [
  ...
  },
  {
    ...
    whatItDoes: 'Keeps docs/process/hook edits on the fast focused path, while preventing deleted verifier, approval, plan, or process files from passing as focused work or producing `node --check` commands for files that no longer exist.',
    whyItMatters: 'The audit warned that bulk verifier cleanup can crash gates when named files vanish. This makes cleanup wait for the full repoint/ship path instead of relying on Steve or a builder to catch the deletion manually.',
    whereItLives: [
      'lib/process-verify-gate-tiering.js deletion-aware classifier',
      'scripts/process-verify-gate-tiering-check.mjs HEAD-diff proof recording',
      'docs/process/foundation-verify-gate-tiering-finish-001-plan.md',
      'docs/process/approvals/FOUNDATION-VERIFY-GATE-TIERING-FINISH-001.json',
      'Foundation tune-up Current Sprint active card',
    ],
    proofCommands: [
      ...
      'npm run process:ship-check -- --card=FOUNDATION-VERIFY-GATE-TIERING-FINISH-001 --planApprovalRef=docs/process/approvals/FOUNDATION-VERIFY-GATE-TIERING-FINISH-001.json --closeoutKey=foundation-verify-gate-tiering-finish-v1 --skipLiveVerify=true --skipLiveVerifyReason=process:foundation-ship-runs-final-foundation-verify',
      'npm run process:fanout-check -- --card=FOUNDATION-VERIFY-GATE-TIERING-FINISH-001 --closeoutKey=foundation-verify-gate-tiering-finish-v1',
      'npm run process:foundation-ship -- --card=FOUNDATION-VERIFY-GATE-TIERING-FINISH-001 --planApprovalRef=docs/process/approvals/FOUNDATION-VERIFY-GATE-TIERING-FINISH-001.json --closeoutKey=foundation-verify-gate-tiering-finish-v1 --commitRef=HEAD',
    ],
    proofStatus: 'Focused proof has 9 synthetic cases, including deleted protected checker -> full gate with no missing-file node check; roadmap, startup packet, backlog hygiene, and foundation:verify pass 519/519 after restart.',
    reviewNext: 'Continue Phase 3 cleanup prerequisites without deleting files first. Safe next unattended card is SOURCE-MATURITY-REPAIR-COLLAPSE-001 scoping/engine work or FOUNDATION-ORPHAN-SCRIPT-REVIEW-001 review-only; keep FOUNDATION-HUB-FOLDER-ISOLATION-001 parked for Steve checkpoint.',
    knownLimits: [
      'This does not archive or delete any verifier, approval, plan, check, closeout, source/browser proof, route-policy, source-session readiness, or Dev Hub System Truth file.',
      'This does not start the per-hub folder restructure.',
      'This does not collapse source-maturity repair clones, closeout records-as-code, oversized frontend files, or done-semantics labeling.',
      'This does not mutate Drive permissions, source rows, browser/session state, atoms/vectors, or external systems.',
    ],
  },
  {
    key: 'source-maturity-repair-collapse-v1',
    backlogIds: ['SOURCE-MATURITY-REPAIR-COLLAPSE-001'],
    match: {
      subjectIncludes: [
        'SOURCE-MATURITY-REPAIR-COLLAPSE-001',
        'source-maturity-repair-collapse-v1',
        'Collapse source-maturity repair clones into one engine',
        'Collapse source maturity repair proofs',
      ],
    },
    operatorCloseout: true,
    systemArea: 'Foundation source-maturity process',
    status: 'accepted',
    acceptanceState: 'Verified',
    whatChanged: 'Added a shared source-maturity repair collapse V1 manifest and reusable proof engine for the existing repair/check clone families.',
    whatItDoes: 'Classifies the current source-maturity repair/check surface into contract, trust, monitoring, evidence, atom-flow, routing, and gap-followup families, then proves one legacy synthetic failure/pass fixture from each family through one shared evaluator.',
    whyItMatters: 'The audit found source-maturity repair clones as a major copy-paste bloat surface. V1 gives future builders a single control point and proof path before any wrapper migration or archive work.',
    whereItLives: [
      'lib/source-maturity-repair-collapse.js shared family manifest and evaluator',
      'scripts/process-source-maturity-repair-collapse-check.mjs reusable focused proof/checker',
      'docs/process/source-maturity-repair-collapse-001-plan.md approved V1 plan',
      'docs/process/approvals/SOURCE-MATURITY-REPAIR-COLLAPSE-001.json approval artifact',
      'package.json process:source-maturity-repair-collapse-check command',
      'Foundation tune-up Current Sprint active-card closeout',
    ],
    proofCommands: [
      ...
      'npm run backlog:hygiene -- --json',
      'npm run foundation:verify -- --json-summary',
      'npm run process:ship-check -- --card=SOURCE-MATURITY-REPAIR-COLLAPSE-001 --planApprovalRef=docs/process/approvals/SOURCE-MATURITY-REPAIR-COLLAPSE-001.json --closeoutKey=source-maturity-repair-collapse-v1 --skipLiveVerify=true --skipLiveVerifyReason=process:foundation-ship-runs-final-foundation-verify',
      'npm run process:fanout-check -- --card=SOURCE-MATURITY-REPAIR-COLLAPSE-001 --closeoutKey=source-maturity-repair-collapse-v1',
    ...
    proofStatus: 'Focused proof classifies 37 source-maturity repair wrappers and 37 checks across 7 families, measures 32,629 lines, runs 7/7 legacy family fixtures, and proves no deletion, source-row mutation, extraction, browser/session, atom/vector, Drive permission, or external-write path.',
    reviewNext: 'Continue the tune-up cleanup sequence with closeout records-as-data or a separate wrapper-migration card. Keep FOUNDATION-HUB-FOLDER-ISOLATION-001 parked for Steve checkpoint.',
    knownLimits: [
      'This is V1 manifest/control collapse. It does not delete, archive, move, or thin the old source-maturity wrapper/check files yet.',
      'Wrapper migration/archive needs a separate follow-up card that repoints gates first and proves named check paths do not break.',
      'This does not start the per-hub folder restructure.',
      'This does not mutate source rows, extraction targets, browser/session state, atoms/vectors, Drive permissions, or external systems.',
      'This does not touch the real source/browser proof lane, local-browser route policy, source-session readiness, or Dev Hub System Truth posture.',
    ],
  },
  {
    key: 'foundation-closeout-records-data-store-v1',
    backlogIds: ['FOUNDATION-CLOSEOUT-RECORDS-DATA-STORE-001'],
    match: {
      subjectIncludes: [
        'FOUNDATION-CLOSEOUT-RECORDS-DATA-STORE-001',
        'foundation-closeout-records-data-store-v1',
        'Move closeout records to data artifact',
      ],
    },
    operatorCloseout: true,
    systemArea: 'Foundation build log / closeout data source',
    status: 'accepted',
    acceptanceState: 'Verified',
    whatChanged: 'Added the first closeout records-as-data storage slice: source-newsletter closeout records now live in a JSON artifact loaded through a reusable validated loader.',
    whatItDoes: 'Keeps the existing JS export surface intact while moving one closeout family out of hand-written JS literals, validating the artifact schema, preserving Build Log/source visibility, and proving fanout still resolves migrated closeout keys.',
    whyItMatters: 'The audit found closeout records-as-code as a major bloat surface. This V1 proves the migration pattern on one small family before touching large registry groups.',
    whereItLives: [
      'data/foundation-build-closeouts/source-newsletter-records.json migrated source-newsletter closeout artifact',
      'lib/foundation-build-closeout-data-artifacts.js reusable JSON artifact loader and validator',
      'lib/foundation-build-closeout-source-newsletter-records.js thin compatibility wrapper',
      'lib/foundation-closeout-records-data-store.js card constants and focused snapshot proof',
      'scripts/process-foundation-closeout-records-data-store-check.mjs reusable focused proof/checker',
      'lib/foundation-build-log-source.js source visibility includes migrated JSON artifacts',
    ],
    proofCommands: [
      ...
      'npm run backlog:hygiene -- --json',
      'npm run foundation:verify -- --json-summary',
      'npm run process:ship-check -- --card=FOUNDATION-CLOSEOUT-RECORDS-DATA-STORE-001 --planApprovalRef=docs/process/approvals/FOUNDATION-CLOSEOUT-RECORDS-DATA-STORE-001.json --closeoutKey=foundation-closeout-records-data-store-v1 --skipLiveVerify=true --skipLiveVerifyReason=process:foundation-ship-runs-final-foundation-verify',
      'npm run process:fanout-check -- --card=FOUNDATION-CLOSEOUT-RECORDS-DATA-STORE-001 --closeoutKey=foundation-closeout-records-data-store-v1',
    ...
    proofStatus: 'Focused proof validates the migrated JSON artifact has 6 records, rejects malformed and duplicate-key fixtures, keeps the JS wrapper at 6 lines, preserves 554 Build Log closeouts with zero invalid closeout keys or ownership overlaps, and proves registry source visibility includes the migrated artifact.',
    reviewNext: 'Continue with oversized-file split work, or scope a separate follow-up to migrate the next closeout family. Keep FOUNDATION-HUB-FOLDER-ISOLATION-001 parked for Steve checkpoint.',
    knownLimits: [
      'This migrates only the source-newsletter closeout family.',
      'This does not migrate all closeout record families, create a closeout DB table, redesign Recent Builds, or delete closeout history.',
      'This does not delete verifier, approval, plan, check, or closeout files.',
      'This does not start the per-hub folder restructure.',
      'This does not mutate source rows, extraction targets, browser/session state, atoms/vectors, Drive permissions, credentials, or external systems.',
      'This does not touch the real source/browser proof lane, local-browser route policy, source-session readiness, or Dev Hub System Truth posture.',
    ],
  },
  {
    key: 'foundation-oversized-file-split-wave-v1',
    backlogIds: ['FOUNDATION-OVERSIZED-FILE-SPLIT-WAVE-001'],
    match: {
      subjectIncludes: [
        'FOUNDATION-OVERSIZED-FILE-SPLIT-WAVE-001',
        'foundation-oversized-file-split-wave-v1',
        'Split Dev CSS oversized file',
      ],
    },
    operatorCloseout: true,
    systemArea: 'Foundation frontend architecture',
    status: 'accepted',
    acceptanceState: 'Verified',
    whatChanged: 'Split the oversized Dev Hub CSS surface into ordered Dev core, YouTube/source intelligence, and source/approval/responsive CSS modules.',
    whatItDoes: 'Keeps the existing Dev page route and visual behavior while moving active styling ownership out of one 4,998-line file and updating the focused proofs to read the same CSS bundle the page loads.',
    whyItMatters: 'The audit flagged oversized files as edit blockers. This V1 lowers frontend collision risk without starting the larger per-hub restructure or weakening the source/browser proof lane.',
    whereItLives: [
      'public/dev.css Dev core CSS after split',
      'public/dev-youtube-source.css YouTube/source intelligence CSS',
      'public/dev-source-approval.css approval/source leaderboard/responsive CSS',
      'public/dev.html ordered CSS bundle links',
      'lib/foundation-oversized-file-split-wave.js card constants and focused snapshot proof',
      'scripts/process-foundation-oversized-file-split-wave-check.mjs focused proof/checker',
    ],
    proofCommands: [
      ...
      'npm run backlog:hygiene -- --json',
      'npm run foundation:verify -- --json-summary',
      'npm run process:ship-check -- --card=FOUNDATION-OVERSIZED-FILE-SPLIT-WAVE-001 --planApprovalRef=docs/process/approvals/FOUNDATION-OVERSIZED-FILE-SPLIT-WAVE-001.json --closeoutKey=foundation-oversized-file-split-wave-v1 --skipLiveVerify=true --skipLiveVerifyReason=process:foundation-ship-runs-final-foundation-verify',
      'npm run process:fanout-check -- --card=FOUNDATION-OVERSIZED-FILE-SPLIT-WAVE-001 --closeoutKey=foundation-oversized-file-split-wave-v1',
    ...
    proofStatus: 'Focused proof measures public/dev.css at 3,109 lines with two bounded CSS modules, proves HTML load order, rejects unsplit oversized and missing-selector fixtures, registers the next non-hub tune-up blockers for historical progression checks, and runs existing Dev Hub/source-session/source-family/System Truth bundle checks before full Foundation ship.',
    reviewNext: 'Continue the tune-up cleanup sequence with FOUNDATION-DONE-SEMANTICS-REPAIR-001. Keep FOUNDATION-HUB-FOLDER-ISOLATION-001 parked for Steve checkpoint.',
    knownLimits: [
      'This splits only public/dev.css. It does not split scripts/foundation-verify.mjs, lib/dev-team-hub.js, public/dev.js, or the remaining oversized files.',
      'This does not redesign the Dev page or change runtime behavior.',
      'This does not delete verifier, approval, plan, check, or closeout files.',
      'This does not start the per-hub folder restructure.',
      'This does not mutate source rows, extraction targets, browser/session state, atoms/vectors, Drive permissions, credentials, or external systems.',
      'This does not touch the real source/browser proof lane, local-browser route policy, source-session readiness, or Dev Hub System Truth posture.',
  ...
  {
    key: 'foundation-done-semantics-repair-v1',
    backlogIds: ['FOUNDATION-DONE-SEMANTICS-REPAIR-001'],
    match: {
      subjectIncludes: [
        'FOUNDATION-DONE-SEMANTICS-REPAIR-001',
        'foundation-done-semantics-repair-v1',
        'Repair done semantics',
      ],
    },
    operatorCloseout: true,
    systemArea: 'Foundation backlog truth',
    status: 'accepted',
    acceptanceState: 'Verified',
    whatChanged: 'Added computed done-outcome semantics to backlog list, done archive, single-card detail, and Foundation UI readback.',
    whatItDoes: 'Classifies done rows as behavior-proven, V1 contract, preflight/contract, blocked/waiting, blocked preflight, or done-needs-review so limiting language cannot masquerade as feature-complete.',
    whyItMatters: 'The audit found done rows with V1, preflight, blocked, pending, and approval-bound language. Steve needs done to mean the right kind of done without remembering chat context.',
    whereItLives: [
      'lib/foundation-backlog-detail.js done semantics classifier and summary',
      'public/foundation.js Done Outcome readback in backlog accordion rows',
      'lib/foundation-done-semantics-repair.js focused snapshot and dogfood proof',
      'scripts/process-foundation-done-semantics-repair-check.mjs focused proof/checker',
    ],
    proofCommands: [
      ...
      'npm run backlog:hygiene -- --json',
      'npm run foundation:verify -- --json-summary',
      'npm run process:ship-check -- --card=FOUNDATION-DONE-SEMANTICS-REPAIR-001 --planApprovalRef=docs/process/approvals/FOUNDATION-DONE-SEMANTICS-REPAIR-001.json --closeoutKey=foundation-done-semantics-repair-v1 --skipLiveVerify=true --skipLiveVerifyReason=process:foundation-ship-runs-final-foundation-verify',
      'npm run process:fanout-check -- --card=FOUNDATION-DONE-SEMANTICS-REPAIR-001 --closeoutKey=foundation-done-semantics-repair-v1',
    ...
    proofStatus: 'Focused proof dogfoods blocked-preflight, preflight-only, bounded V1, behavior-proven, unclear, and not-done fixtures; checks live backlog list/archive/detail summaries and UI readback; blocks V1/preflight/blocked/unclear rows from feature-complete claims.',
    reviewNext: 'Continue the tune-up cleanup sequence with FOUNDATION-ORPHAN-SCRIPT-REVIEW-001. Keep FOUNDATION-HUB-FOLDER-ISOLATION-001 parked for Steve checkpoint.',
    knownLimits: [
      'This does not rewrite historical backlog rows; it adds computed readback semantics over existing text.',
      'This does not prove every old done card is behavior-complete; unclear rows remain review candidates.',
      'This does not delete verifier, approval, plan, check, closeout, or source files.',
      'This does not start the per-hub folder restructure.',
      'This does not mutate source rows, extraction targets, browser/session state, atoms/vectors, Drive permissions, credentials, or external systems.',
      'This does not touch the real source/browser proof lane, local-browser route policy, source-session readiness, or Dev Hub System Truth posture.',
    ],
  ...
  {
    key: 'foundation-orphan-script-review-v1',
    backlogIds: ['FOUNDATION-ORPHAN-SCRIPT-REVIEW-001'],
    match: {
      subjectIncludes: [
        'FOUNDATION-ORPHAN-SCRIPT-REVIEW-001',
        'foundation-orphan-script-review-v1',
        'Review orphan scripts without deleting first',
      ],
    },
    operatorCloseout: true,
    systemArea: 'Foundation process cleanup',
    status: 'accepted',
    acceptanceState: 'Verified',
    whatChanged: 'Added a no-delete orphan-script review manifest and proof for the audit-named script candidates.',
    whatItDoes: 'Records owner-backed keep decisions for codex-chat, codex-status, doc index generation, weekly actuals inspection, paid-source browser mapping, and Zoom text archive sync scripts without moving or deleting files.',
    whyItMatters: 'The audit warned that file-level orphan signal is noisy. This prevents a useful local operator tool or source/browser proof script from being removed just because imports do not point at it.',
    whereItLives: [
      'lib/foundation-orphan-script-review.js candidate manifest, evaluator, and dogfood proof',
      'scripts/process-foundation-orphan-script-review-check.mjs focused proof/checker',
      'docs/process/foundation-orphan-script-review-001-plan.md approved V1 plan',
      'docs/process/approvals/FOUNDATION-ORPHAN-SCRIPT-REVIEW-001.json approval artifact',
      'Foundation tune-up Current Sprint active-card closeout',
    ],
    proofCommands: [
      ...
      'npm run backlog:hygiene -- --json',
      'npm run foundation:verify -- --json-summary',
      'npm run process:ship-check -- --card=FOUNDATION-ORPHAN-SCRIPT-REVIEW-001 --planApprovalRef=docs/process/approvals/FOUNDATION-ORPHAN-SCRIPT-REVIEW-001.json --closeoutKey=foundation-orphan-script-review-v1 --skipLiveVerify=true --skipLiveVerifyReason=process:foundation-ship-runs-final-foundation-verify',
      'npm run process:fanout-check -- --card=FOUNDATION-ORPHAN-SCRIPT-REVIEW-001 --closeoutKey=foundation-orphan-script-review-v1',
    ...
    proofStatus: 'Focused proof keeps 7/7 named scripts with owner/classification/reference rationale, protects codex-status and paid-source browser proof, identifies Zoom text sync as write-capable manual archive sync, and rejects protected delete-first plus unsupported keep fixtures.',
    reviewNext: 'Continue the tune-up sequence with FOUNDATION-DOC-CONSOLIDATION-TRUTH-ARCHIVE-001 if Steve wants safe unattended cleanup. Keep FOUNDATION-HUB-FOLDER-ISOLATION-001 parked for Steve checkpoint.',
    knownLimits: [
      'This does not delete, archive, rename, or move any script.',
      'This does not repoint package scripts or verifier gates away from existing script paths.',
      'This does not make sync-zoom-text-archive.mjs dry-run-by-default; it only names the write-capable posture for future review.',
      'This does not start the per-hub folder restructure.',
      'This does not work MEETING-VAULT-ACL-001 Phase B.',
      'This does not mutate source rows, extraction targets, browser/session state, atoms/vectors, Drive permissions, credentials, or external systems.',
      'This does not touch the real source/browser proof lane, local-browser route policy, source-session readiness, or Dev Hub System Truth posture.',
    ],
  },
  {
    key: 'foundation-doc-consolidation-truth-archive-v1',
    backlogIds: ['FOUNDATION-DOC-CONSOLIDATION-TRUTH-ARCHIVE-001'],
    match: {
      subjectIncludes: [
        'FOUNDATION-DOC-CONSOLIDATION-TRUTH-ARCHIVE-001',
        'foundation-doc-consolidation-truth-archive-v1',
        'Classify docs without deleting useful material',
      ],
    },
    operatorCloseout: true,
    systemArea: 'Foundation process cleanup',
    status: 'accepted',
    acceptanceState: 'Verified',
    whatChanged: 'Added a no-delete doc classification proof for canonical truth, supporting docs, active handoffs/audits, plan history, and archive buckets.',
    whatItDoes: 'Turns the doc-consolidation audit item into a runnable readback that scans tracked markdown, preserves archive material, and lists bounded competing current-truth language for later review.',
    whyItMatters: 'Steve can keep useful handoffs, audits, and source notes without letting old markdown masquerade as current operating truth.',
    whereItLives: [
      'lib/foundation-doc-consolidation-truth-archive.js classification snapshot and dogfood proof',
      'scripts/process-foundation-doc-consolidation-truth-archive-check.mjs focused proof/checker',
      'docs/process/foundation-doc-consolidation-truth-archive-001-plan.md approved V1 plan',
      'docs/process/approvals/FOUNDATION-DOC-CONSOLIDATION-TRUTH-ARCHIVE-001.json approval artifact',
      'Foundation tune-up Current Sprint active-card closeout',
    ],
    proofCommands: [
      ...
      'npm run backlog:hygiene -- --json',
      'npm run foundation:verify -- --json-summary',
      'npm run process:ship-check -- --card=FOUNDATION-DOC-CONSOLIDATION-TRUTH-ARCHIVE-001 --planApprovalRef=docs/process/approvals/FOUNDATION-DOC-CONSOLIDATION-TRUTH-ARCHIVE-001.json --closeoutKey=foundation-doc-consolidation-truth-archive-v1 --skipLiveVerify=true --skipLiveVerifyReason=process:foundation-ship-runs-final-foundation-verify',
      'npm run process:fanout-check -- --card=FOUNDATION-DOC-CONSOLIDATION-TRUTH-ARCHIVE-001 --closeoutKey=foundation-doc-consolidation-truth-archive-v1',
    ...
    proofStatus: 'Focused proof scans tracked markdown from git truth, preserves archive and active handoff/audit groups, classifies explicit canonical paths, and dogfoods canonical/archive/stale-current behavior without moving or deleting docs.',
    reviewNext: 'Continue with FOUNDATION-TUNEUP-REMAP-PROOF-001 to measure the tune-up before any per-hub restructure. Keep FOUNDATION-HUB-FOLDER-ISOLATION-001 parked for Steve checkpoint.',
    knownLimits: [
      'This does not delete, archive, rename, move, or rewrite any doc.',
      'This does not consolidate doc content into fewer files yet; it creates the classification/readback guard first.',
      'This does not decide every stale-current wording candidate; it lists bounded review candidates for follow-up.',
      'This does not start the per-hub folder restructure.',
      'This does not work MEETING-VAULT-ACL-001 Phase B.',
      'This does not mutate source rows, extraction targets, browser/session state, atoms/vectors, Drive permissions, credentials, or external systems.',
      'This does not touch the real source/browser proof lane, local-browser route policy, source-session readiness, or Dev Hub System Truth posture.',
  ...
  {
    key: 'foundation-tuneup-remap-proof-v1',
    backlogIds: ['FOUNDATION-TUNEUP-REMAP-PROOF-001'],
    match: {
      subjectIncludes: [
        'FOUNDATION-TUNEUP-REMAP-PROOF-001',
        'foundation-tuneup-remap-proof-v1',
        'Capture tune-up before/after remap proof',
      ],
    },
    operatorCloseout: true,
    systemArea: 'Foundation process cleanup',
    status: 'accepted',
    acceptanceState: 'Verified',
    whatChanged: 'Added a read-only tune-up remap proof that compares the audit baselines to live repo facts after the overnight cleanup sequence.',
    whatItDoes: 'Runs the AIOS-owned codebase map, counts remaining Foundation DB facade imports, checks Dev CSS split evidence, lists remaining oversized files, and leaves the per-hub restructure checkpoint-only.',
    whyItMatters: 'Steve gets a measurable morning before/after read instead of trusting chat claims that the repo got leaner.',
    whereItLives: [
      'lib/foundation-tuneup-remap-proof.js before/after snapshot and dogfood proof',
      'scripts/process-foundation-tuneup-remap-proof-check.mjs focused proof/checker',
      'docs/process/foundation-tuneup-remap-proof-001-plan.md approved V1 plan',
      'docs/process/approvals/FOUNDATION-TUNEUP-REMAP-PROOF-001.json approval artifact',
      'lib/agentic-codebase-map.js script visibility repair for current Source Browser proof commands',
      'lib/foundation-verify-coverage-card-ids.js progression registry entry for the per-hub checkpoint',
      'Foundation tune-up Current Sprint checkpoint handoff',
    ],
    proofCommands: [
      ...
      'npm run backlog:hygiene -- --json',
      'npm run foundation:verify -- --json-summary',
      'npm run process:ship-check -- --card=FOUNDATION-TUNEUP-REMAP-PROOF-001 --planApprovalRef=docs/process/approvals/FOUNDATION-TUNEUP-REMAP-PROOF-001.json --closeoutKey=foundation-tuneup-remap-proof-v1 --skipLiveVerify=true --skipLiveVerifyReason=process:foundation-ship-runs-final-foundation-verify',
      'npm run process:fanout-check -- --card=FOUNDATION-TUNEUP-REMAP-PROOF-001 --closeoutKey=foundation-tuneup-remap-proof-v1',
    ...
    proofStatus: 'Focused proof runs the actual codebase map, compares 551 audit-baseline Foundation DB facade import pressure to live importers, verifies Dev CSS split evidence against the 4,998-line baseline, lists remaining oversized risks, and dogfoods unreduced import pressure plus accidentally started hub implementation.',
    reviewNext: 'Stop for Steve checkpoint before FOUNDATION-HUB-FOLDER-ISOLATION-001. Do not implement per-hub folders until Steve reviews the remap proof and explicitly approves the build card.',
    knownLimits: [
      'This does not implement the per-hub folder restructure.',
      'This does not delete, archive, rename, move, or rewrite docs, verifier files, closeout records, plans, approvals, or scripts.',
      'This does not claim all source-maturity wrappers or closeout records are fully collapsed; it records the current proof and remaining visible risk.',
      'This does not install Understand-Anything or commit generated graph artifacts.',
      'This does not work MEETING-VAULT-ACL-001 Phase B.',
      'This does not mutate source rows, extraction targets, browser/session state, atoms/vectors, Drive permissions, credentials, or external systems.',
      'This does not touch the real source/browser proof lane, local-browser route policy, source-session readiness, or Dev Hub System Truth posture.',
    ],
  ...
  },
  {
    ...
    whereItLives: [
      ...
      'docs/_archive/handoffs/2026-05-19-current-sprint-active-card-gate-closeout.md',
