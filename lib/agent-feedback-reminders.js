...
function syntheticCandidate(overrides = {}) {
  return {
    ...
    recipientSource: overrides.recipientSource || 'personal_email',
    recipientRule: overrides.recipientRule || 'clickup-personal-email',
    recipientCategory: overrides.recipientCategory || 'external-agent',
    recipientFieldName: overrides.recipientFieldName || 'Personal Email',
    recipientFieldNameHash: hashAgentFeedbackProofValue(overrides.recipientFieldName || 'Personal Email'),
