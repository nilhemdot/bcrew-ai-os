...
const closeoutRecords = [
  ...
  },
  {
    ...
    proofCommands: [
      ...
      'npm run process:post-ship-fanout -- --card=DOCTRINE-PROPAGATION-001 --closeoutKey=doctrine-propagation-v1 --commitRef=HEAD',
    ],
    ...
    knownLimits: [
      'The doctrine source list is hardcoded in lib/doctrine-propagation.js as plain-English summaries. New memory entries only trigger review; they do not auto-copy content.',
