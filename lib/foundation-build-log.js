...
const closeoutRecords = [
  ...
  },
  {
    ...
    proofStatus: 'Production proof is metadata-only. It shows production auto-send enabled, one controlled run, Gmail-before-ClickUp Requested sequencing, duplicate ledger protection, no raw emails, no token URLs, no raw tokens, no broad feedback content, live Runtime/Ops enabled/send-window/last/next/counts, Agent Onboarding Feedback source truth marked live, submitted-feedback path still healthy, internal notification healthy, and reminder stop/report-only guardrails healthy.',
    reviewNext: 'Stop for Steve review. Next work is Foundation + Strategy only.',
    knownLimits: [
      'Live reminders remain report-only in this card because reminder emails are follow-up sends and need a separate approval before repeated outreach starts.',
