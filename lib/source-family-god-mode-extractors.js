...
function operatorBoundaryFor(family = {}) {
  ...
  if (family.familyId === 'creator-newsletters') return 'standing_free_newsletter_policy_required'
...
export function buildSourceFamilyGodModeMaturityDogfoodProof() {
  ...
  const falsePaid = {
    ...validSnapshot,
    families: validSnapshot.families.map(family => family.familyId === 'paid-course-training-platforms'
