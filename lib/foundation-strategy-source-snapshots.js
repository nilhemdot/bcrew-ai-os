...
export async function getLiveAgentEngineSourceSnapshot() {
  ...
  const planningAttritionDetail = 'First-class planning attrition assumption from the BHAG builder; this is the model input used by required recruiting pace and is separate from live attrition pressure.'
  ...
  const snapshot = [
    ...
    },
    {
      ...
      value: formatPercent(planningAttritionAssumption),
      detail: planningAttritionDetail,
      asOf: getTodayTorontoIso(),
      sortOrder: 3,
    },
  ]
