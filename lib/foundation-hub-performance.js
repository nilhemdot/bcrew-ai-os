import {
  ...
  buildFoundationHubPayloadBudgetV2Status,
...
export const FOUNDATION_HUB_SUMMARY_BUDGET = {
  mode: 'summary',
  maxDurationMs: 2500,
  maxPayloadBytes: FOUNDATION_HUB_PAYLOAD_BUDGET_V2_SUMMARY_BUDGET.maxPayloadBytes,
}
...
export function attachFoundationHubPerformanceMetadata(payload, {
  ...
  const body = {
    ...
    foundationHubPayloadBudgetV2: null,
  }
  ...
  body.foundationHubPayloadBudgetV2 = normalizedMode === 'summary'
    ? buildFoundationHubPayloadBudgetV2Status({
        payload: body,
        mode: normalizedMode,
        durationMs: body.foundationHubPerformance.durationMs,
