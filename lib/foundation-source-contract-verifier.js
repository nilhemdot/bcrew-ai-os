...
export function buildFoundationSourceContractVerifierDogfoodProof() {
  ...
  return {
    ...
    invariant: 'The source-contract verifier accepts signed-off source truth and rejects missing signoff, missing tab coverage, stale registry rows, stale current-state mirror boundaries, missing DB source-contract registry proof, missing scalar source-ID FK enforcement, and missing array source-ID provenance design.',
  }
}
