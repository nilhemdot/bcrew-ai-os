...
export const VERIFIER_SOURCE_CONTRACT_ORCHESTRATION_SPLIT_HANDOFF_PATH = 'docs/handoffs/2026-05-17-verifier-source-contract-orchestration-split-closeout.md'
...
export function buildFoundationSourceContractVerifierDogfoodProof() {
  ...
  return {
    ...
    invariant: 'The source-contract verifier accepts signed-off source truth and rejects missing signoff, missing tab coverage, stale registry rows, stale current-state mirror boundaries, missing DB source-contract registry proof, missing scalar source-ID FK enforcement, missing array source-ID provenance design, and missing source-contract validation-layer proof.',
  }
}
