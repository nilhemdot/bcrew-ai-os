...
export const MARK_KASHEF_BASELINE_BASE_MODEL = process.env.GOD_MODE_YOUTUBE_BASE_MODEL || 'gemini-2.5-flash'
export const MARK_KASHEF_BASELINE_CANDIDATE_MODEL = process.env.GOD_MODE_YOUTUBE_CANDIDATE_MODEL || 'gemini-3.5-flash'
