...
export const CREATOR_WATCHLIST_ENTRIES = [
  ...
  ...[
    ...
    {
      creatorId: 'steve-builder-comprehension-lead-url-confirmation',
      displayName: 'Steve Builder-Comprehension Video Lead / Creator TBD',
      priority: 'P0',
      evidence: [
        'Steve flagged this as important on 2026-05-26 and said it should be watched by extractors and by Codex/Claude Code/builders to understand the codebase/system better.',
        'Steve supplied youtu.be/vmiuxvlt7_i twice with different share tokens, then noted he may have provided the wrong link.',
        'The exact lower-case video ID vmiuxvlt7_i returned YouTube "Video unavailable" during intake, so do not spend extraction/model budget until Steve confirms the correct URL/title/creator.',
      ],
      sourceRefs: [
        { sourceKey: 'steve-builder-comprehension-video-lead-unconfirmed', url: 'https://www.youtube.com/watch?v=vmiuxvlt7_i', sourceType: 'public_youtube_video_unconfirmed', lookupStatus: 'operator_supplied_unavailable_needs_url_confirmation' },
      ],
    },
    {
