...
export const CREATOR_WATCHLIST_ENTRIES = [
  ...
  ...[
    ...
    },
    {
      ...
      sourceRefs: [
        { sourceKey: 'brad-bonanno-claude-code-watch-any-video', url: 'https://www.youtube.com/watch?v=QZMljuD10sU', sourceType: 'public_youtube_video', lookupStatus: 'known_public_video_pending_god_mode_extraction' },
      ],
    },
    {
