...
export const CREATOR_WATCHLIST_ENTRIES = [
  ...
  ...[
    ...
    },
    {
      ...
      evidence: ['Developer Educators identifies ambITious | AI as @ambitious1z.'],
    },
    {
    ...
    },
    {
      ...
      evidence: ['Steve requested David Ondrej as a Build Intel source on 2026-05-23 after the public video "Why This Dev Ships 100x Faster Than 99% of Engineers" matched the context-engineering / agentic-engineering sprint theme.'],
      sourceRefs: [
        ...
        { sourceKey: 'david-ondrej-aleksdeveloper698-comment', url: 'https://www.youtube.com/watch?v=PzVV4X37ihg', sourceType: 'public_youtube_comment_observation', lookupStatus: 'observed_public_comment_pending_deeper_review' },
      ],
    },
