...
export const CREATOR_WATCHLIST_ENTRIES = [
  ...
  ...[
    ...
    { creatorId: 'chris-bradley', displayName: 'Chris Bradley' },
    {
    ...
    { creatorId: 'brad-ai-automation', displayName: 'Brad | AI & Automation' },
    {
    ...
    { creatorId: 'stacked-podcast', displayName: 'Stacked Podcast' },
    {
      creatorId: 'zane-cole',
