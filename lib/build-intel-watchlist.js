...
export const CREATOR_WATCHLIST_ENTRIES = [
  ...
  },
  {
    ...
    platforms: [
      ...
      platform('youtube', 'Everyday AI YouTube', {
        url: 'https://www.youtube.com/@EverydayAI_/videos',
        lookupStatus: 'known_public_url',
        accessBoundary: 'public_lookup_required',
        lookupEvidence: ['Steve supplied the exact public Everyday AI videos page on 2026-05-26.'],
      }),
    ...
    sourceRefs: [
      ...
      { sourceKey: 'everyday-ai-youtube', url: 'https://www.youtube.com/@EverydayAI_/videos', sourceType: 'public_youtube_channel', lookupStatus: 'known_public_url' },
  ...
  },
  {
    ...
    platforms: [
      ...
      platform('youtube', 'Karpathy YouTube', {
        ...
        accessBoundary: 'public_lookup_required',
        lookupEvidence: [
          'Steve corrected the public YouTube channel to @AndrejKarpathy on 2026-05-27 after @karpathy produced unrelated/low-signal old videos.',
        ],
      }),
    ],
    sourceRefs: [
      ...
      { sourceKey: 'karpathy-youtube', url: 'https://www.youtube.com/@AndrejKarpathy', sourceType: 'public_youtube_channel', lookupStatus: 'known_public_url' },
    ],
    active: true,
  },
  {
  ...
  },
  {
    ...
    platforms: [
      ...
      platform('web', 'Nick Saraev site', {
        ...
        accessBoundary: 'public_lookup_required',
        lookupEvidence: [
          'Nick Saraev official site describes his AI, automation, and Maker School work.',
          'Steve flagged Nick Saraev video gcuR_-rzlDw on 2026-05-27 as important for improving the BCrew AI coding/operator workflow.',
        ],
      }),
    ],
    sourceRefs: [
      publicYoutubeRef('nick-saraev-youtube', 'https://www.youtube.com/@nicksaraev'),
      { sourceKey: 'nick-saraev-vibe-coding-full-course-gcuR', url: 'https://www.youtube.com/watch?v=gcuR_-rzlDw', sourceType: 'public_youtube_long_course', lookupStatus: 'known_public_long_course_pending_bounded_extraction', title: 'VIBE CODING FULL COURSE: Gemini 3.1 + Antigravity (6 Hrs)' },
  ...
  ...[
    ...
    {
      creatorId: 'alex-finn-official',
      displayName: 'Alex Finn Official',
      youtubeUrl: 'https://www.youtube.com/@AlexFinnOfficial',
      priority: 'P0',
      evidence: ['Steve corrected the Build Intel watchlist on 2026-05-27: @AlexFinn was the wrong skate/BMX channel; use @AlexFinnOfficial.'],
    },
    {
    ...
    },
    {
      ...
      evidence: [
        'Steve supplied Brad Bonanno as the Brad AI & Automation public YouTube channel on 2026-05-23.',
        'Steve supplied the /watch comparison video on 2026-05-25; YouTube oEmbed resolves QZMljuD10sU to "My Claude Code Can INSTANTLY Watch Any Video (Here\'s How)" by Brad | AI & Automation.',
      ],
      sourceRefs: [
        { sourceKey: 'brad-bonanno-claude-code-watch-any-video', url: 'https://www.youtube.com/watch?v=QZMljuD10sU', sourceType: 'public_youtube_video', lookupStatus: 'known_public_video_god_mode_extracted_report_ready' },
      ],
    },
    {
      creatorId: 'better-stack',
      displayName: 'Better Stack',
      youtubeUrl: 'https://www.youtube.com/channel/UCkVfrGwV-iG9bSsgCbrNPxQ',
      priority: 'P0',
      evidence: [
        'Steve flagged the codebase mapping topic as important on 2026-05-26 and later supplied the corrected Better Stack channel/video on 2026-05-28.',
        'Trigger video VmIUXVlt7_I is "This AI Tool Maps Any Codebase Before You Touch It (Understand-Anything)" by Better Stack, 7:23, May 20 2026.',
        'The video/source lead points to github.com/Lum1104/Understand-Anything, a Claude Code plugin that maps a codebase into a knowledge graph and is a direct alternative to graphify-style codebase mapping.',
      ],
      sourceRefs: [
        { sourceKey: 'better-stack-understand-anything-video', url: 'https://www.youtube.com/watch?v=VmIUXVlt7_I', sourceType: 'public_youtube_video', lookupStatus: 'known_public_url', title: 'This AI Tool Maps Any Codebase Before You Touch It (Understand-Anything)' },
        { sourceKey: 'better-stack-understand-anything-repo', url: 'https://github.com/Lum1104/Understand-Anything', sourceType: 'public_github_repo', lookupStatus: 'known_public_url' },
      ],
    },
    {
    ...
    },
    {
      ...
      youtubeUrl: 'https://www.youtube.com/@iamAImaster/videos',
      priority: 'P0',
      evidence: [
        'Steve supplied AI Master as a Build Intel watchlist source on 2026-05-26 while resetting the mission to YouTube catch-up first.',
        'YouTube oEmbed resolves Short 5JLfxvzJbQQ to "This AI browses websites like a human (no API needed)" by AI Master with author_url https://www.youtube.com/@iamAImaster.',
      ],
      sourceRefs: [
        { sourceKey: 'ai-master-human-like-browser-short', url: 'https://www.youtube.com/shorts/5JLfxvzJbQQ', sourceType: 'public_youtube_short', lookupStatus: 'known_public_video_pending_god_mode_extraction' },
      ],
    },
    {
    ...
    {
      creatorId: 'zane-cole',
      displayName: 'Zane Thinks / Zane Cole',
      youtubeUrl: 'https://www.youtube.com/@zanethinks/videos',
      evidence: ['Steve supplied the exact public Zane Thinks videos page on 2026-05-26; public Skool profile/search snippets tie Zane Cole to Claude Code app/client-building content.'],
      sourceRefs: [
    ...
    },
    {
      ...
      displayName: 'NextGen IA',
      youtubeUrl: 'https://www.youtube.com/@NextGen_IA_YT/videos',
      evidence: ['Steve supplied the exact public NextGen IA videos page on 2026-05-26.'],
    },
    {
    ...
    {
      creatorId: 'steve-ai-browser-video-lead-aa-piqgxkui',
      displayName: 'Steve AI Browser Video Lead / Creator TBD',
      priority: 'P0',
      evidence: [
        'Steve supplied youtu.be/aa-piqgxkui on 2026-05-28 and said we should probably follow this creator and watch him.',
        'The exact lower-case video ID aa-piqgxkui returned YouTube oEmbed HTTP 400 during intake, and the page did not expose a title or author in public readback.',
        'Keep this as an unconfirmed lead until Steve supplies the corrected case-sensitive URL, title, or creator channel.',
      ],
      sourceRefs: [
        { sourceKey: 'steve-ai-browser-video-lead-aa-piqgxkui-unconfirmed', url: 'https://www.youtube.com/watch?v=aa-piqgxkui', sourceType: 'public_youtube_video_unconfirmed', lookupStatus: 'operator_supplied_unavailable_needs_url_confirmation' },
      ],
    },
    {
      creatorId: 'samin-yasar',
      displayName: 'Samin Yasar',
      youtubeUrl: 'https://www.youtube.com/@SaminYasar_',
      evidence: [
        'Steve supplied the public Samin Yasar videos page on 2026-05-25 after flagging the Hermes Agent content-team video.',
        'YouTube channel metadata identifies Samin Yasar as @SaminYasar_ and describes the channel as practical AI examples from an ex-Amazon engineer.',
        'YouTube oEmbed resolves video B6tEsURlM3I to "I Built a Content Team with Hermes Agent for $99/Month" by Samin Yasar.',
      ],
      sourceRefs: [
        { sourceKey: 'samin-yasar-hermes-content-team-video', url: 'https://www.youtube.com/watch?v=B6tEsURlM3I', sourceType: 'public_youtube_video', lookupStatus: 'known_public_video_pending_god_mode_extraction' },
      ],
    },
  ].map(({ creatorId, displayName, youtubeUrl = '', evidence = [], sourceRefs = [], priority = '' }) => ({
    creatorId,
    displayName,
    sourceCategory: 'build_intel',
    priority: priority || (displayName === 'Alex Finn' ? 'P0' : 'P1'),
    accessBoundary: 'public_lookup_required',
    consumerLane: 'build_intel',
    cadence: 'weekly',
    whySteveCares: buildIntelWhy,
