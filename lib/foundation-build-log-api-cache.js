...
export async function buildFoundationBuildLogApiCacheDogfoodProof() {
  ...
  return {
    ...
    groupPayload,
    pinnedCloseout,
    dogfoodInvariant: 'Repeated reads within TTL reuse cached build-log data, groups contain refs instead of duplicated build objects, and pinned historical closeouts stay visible outside the rolling git window.',
  }
}
