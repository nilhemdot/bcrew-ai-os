...
const youtubeCreatorDailyWatchPlan = buildYoutubeCreatorDailyWatchPlan()
const youtubeCreatorDailyWatchCreatorCount = youtubeCreatorDailyWatchPlan.creators.length
...
export const SOURCE_LIFECYCLE_APPROVED_TARGET_BASELINE = {
  ...
  'youtube-creator-daily-watch': {
    ...
    budget: {
      llmBudget: 'none',
      dailyMissionQuota: 1,
      maxItemsPerRun: youtubeCreatorDailyWatchCreatorCount,
      maxRuntimeSeconds: 1800,
      maxCreatorsPerRun: youtubeCreatorDailyWatchCreatorCount,
  ...
  'source-browser-agent-runs': {
    ...
    schedulerMode: 'manual',
    budget: {
      llmBudget: 'none_for_source_browser_recovery',
      maxItemsPerRun: 20,
      maxRuntimeSeconds: 3900,
    },
  },
  ...
  'myicor-mcp-catalog-snapshot-v1': {
  ...
  'myicor-approved-lesson-extract-proof-v1': {
    sourceId: 'SRC-MYICRO-001',
    status: 'complete',
    runtimeMode: 'manual',
    schedulerMode: 'manual',
