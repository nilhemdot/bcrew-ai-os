...
function hasFoundationDbFacadeImport(source = '') {
  return /\bfrom\s+['"][^'"]*foundation-db\.js['"]/.test(source) ||
    /\bimport\(['"][^'"]*foundation-db\.js['"]\)/.test(source)
}
...
export function buildFoundationTuneupRemapDogfoodProof() {
  const healthy = buildFoundationTuneupRemapSnapshot({
    ...
    trackedSources: {
      'lib/foundation-db-session.js': "import { x } from './foundation-db.js'\n",
      'lib/foundation-backlog-sprint-db.js': "import { x } from './foundation-db.js'\n",
      'lib/foundation-source-crawl-db.js': "import { x } from './foundation-db.js'\n",
      'lib/foundation-intelligence-db.js': "import { x } from './foundation-db.js'\n",
      'lib/foundation-runtime-jobs-db.js': "import { x } from './foundation-db.js'\n",
      'lib/foundation-strategy-docs-db.js': "import { x } from './foundation-db.js'\n",
      'lib/foundation-shared-comms-db.js': "import { x } from './foundation-db.js'\n",
      'lib/foundation-people-sales-db.js': "import { x } from './foundation-db.js'\n",
...
export function buildFoundationTuneupRemapSnapshot({
  ...
  addCheck(
    checks,
    importSnapshot.directImporterCount <= 10 &&
      importSnapshot.reductionFromBaseline >= 540 &&
      importSnapshot.domainImporterCount === FOUNDATION_DB_DOMAIN_MODULES.size,
