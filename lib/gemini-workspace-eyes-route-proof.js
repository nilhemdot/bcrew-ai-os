...
export const GEMINI_WORKSPACE_EYES_ROUTE_CLOSEOUT_PATH = 'docs/handoffs/2026-05-23-gemini-workspace-eyes-route-proof-closeout.md'
...
export async function runGeminiWorkspaceEyesBrowserProof({
  ...
  try {
    ...
    const prompt = buildGeminiWorkspaceEyesPrompt({ video, apiBaseline })
