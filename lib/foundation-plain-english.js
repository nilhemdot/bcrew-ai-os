...
export const PLAIN_ENGLISH_SWEEP_MANUAL_REVIEW_PATH = 'docs/_archive/audits/2026-04-30-plain-english-sweep-manual-review.md'
...
async function readProofSourceForPath(repoRoot, relativePath) {
  if (relativePath === 'public/foundation.js') {
    const parts = await Promise.all([
      ...
      readOptionalText(path.join(repoRoot, 'public/foundation-source-registry-renderers.js')),
      readOptionalText(path.join(repoRoot, 'public/foundation-fub-lead-source-renderers.js')),
      readOptionalText(path.join(repoRoot, 'public/foundation-system-inventory-renderers.js')),
      readOptionalText(path.join(repoRoot, 'public/foundation-current-state-renderers.js')),
      readOptionalText(path.join(repoRoot, 'public/foundation-decision-question-renderers.js')),
