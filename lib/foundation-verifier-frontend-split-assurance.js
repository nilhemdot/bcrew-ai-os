...
export const VERIFIER_FRONTEND_SPLIT_ASSURANCE_HANDOFF_PATH = 'docs/_archive/handoffs/2026-05-19-hot-doc-cleanup/2026-05-17-verifier-frontend-split-assurance-closeout.md'
...
export async function evaluateFoundationVerifierFrontendSplitAssurance(input = {}) {
  ...
  const foundationVerifyLineCountAfterFrontendVerifierSplit = String(foundationVerifySource || '').split('\n').length
    ...
    verifierFrontendSplitModuleCard &&
      ...
      await repoFileExists('docs/_archive/handoffs/2026-05-19-hot-doc-cleanup/2026-05-15-verifier-frontend-split-checks-module-closeout.md') &&
