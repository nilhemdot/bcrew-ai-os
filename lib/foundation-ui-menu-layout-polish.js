...
export async function buildUiMenuLayoutPolishStatus({
  ...
  if (foundationHub) {
    addFinding(findings, phaseGReadiness.nextPlanCard === 'RECENT-BUILDS-BILLION-DOLLAR-UI-001', 'live current-truth next card advanced after closeout', phaseGReadiness.nextPlanCard || 'missing')
