...
export const SECURITY_ROUTE_POSTURES = [
  ...
  route('POST', '/api/foundation/action-route-review-inbox/:routeId/workflow', ownerTier1),
  ...
  route('GET', '/api/foundation/users/admin', ownerTier1),
  route('POST', '/api/foundation/users/admin', ownerTier1),
  route('PATCH', '/api/foundation/users/admin/:email', ownerTier1),
