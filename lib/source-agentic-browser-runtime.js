...
export const SOURCE_AGENTIC_BROWSER_DEFAULT_MODEL = process.env.SOURCE_AGENTIC_BROWSER_MODEL || 'openai/gpt-5.5'
...
export async function runSourceAgenticBrowserProbe({
  ...
  const report = {
    ...
    next: status === 'agentic_browser_completed_with_blocker'
